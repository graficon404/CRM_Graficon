<?php
   ...
   session_start();
    $Ord_Cmp = new grid_documentos_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_documentos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $_POST, $_GET;
   ...
   $tab_def_campos['id_documento'] = "id_documento";
   $tab_converte["id_documento"]   = "id_documento";
   $tab_ger_campos['decripcion_doc'] = "on";
   $tab_def_campos['decripcion_doc'] = "Decripcion_doc";
   $tab_converte["Decripcion_doc"]   = "decripcion_doc";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_converte["numero"]   = "numero";
   $tab_ger_campos['punto_vta'] = "on";
   $tab_def_campos['punto_vta'] = "Punto_vta";
   $tab_converte["Punto_vta"]   = "punto_vta";
   $tab_ger_campos['cantidad_filas'] = "on";
   $tab_def_campos['cantidad_filas'] = "Cantidad_filas";
   $tab_converte["Cantidad_filas"]   = "cantidad_filas";
   $tab_ger_campos['control_stock'] = "on";
   $tab_def_campos['control_stock'] = "Control_stock";
   $tab_converte["Control_stock"]   = "control_stock";
   $tab_ger_campos['graba_caja'] = "on";
   $tab_def_campos['graba_caja'] = "Graba_caja";
   $tab_converte["Graba_caja"]   = "graba_caja";
   $tab_ger_campos['graba_cliente_ctacte'] = "on";
   $tab_def_campos['graba_cliente_ctacte'] = "Graba_cliente_ctacte";
   $tab_converte["Graba_cliente_ctacte"]   = "graba_cliente_ctacte";
   $tab_ger_campos['graba_prov_ctacte'] = "on";
   $tab_def_campos['graba_prov_ctacte'] = "Graba_prov_Ctacte";
   $tab_converte["Graba_prov_Ctacte"]   = "graba_prov_ctacte";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_documentos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_documentos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_documentos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_documentos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_documentos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_documentos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_documentos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_documentos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['grid_documentos']['ordem_select'][$campo] = $ordem;
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_documentos']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
...
?>
       <OPTION value="<?php echo NM_encode_input($tab_def_campos[$NM_cada_field]); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['grid_documentos']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_documentos']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
...
?>
             <OPTION value="<?php echo NM_encode_input($class . $NM_cada_field); ?>" selected><?php echo $class . $_SESSION['sc_session'][$sc_init]['grid_documentos']['labels'][$tab_converte[$NM_cada_field]]; ?></OPTION>
<?php
       }
   }
?>
