<?php  
  ...
  session_start() ;
  class grid_documentos_form_teste
  {
  function grid_documentos_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_documentos</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_documentos"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_documentos_form_teste();
  $frm_teste->grid_documentos_teste();
?>
