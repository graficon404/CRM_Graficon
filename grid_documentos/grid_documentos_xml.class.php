...
class grid_documentos_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_documentos.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_documentos']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_documentos']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_documentos']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_documentos']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_documentos";
   ...
   function NM_export_id_documento()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_documento))
         {
             $this->id_documento = mb_convert_encoding($this->id_documento, "UTF-8");
         }
         $this->xml_registro .= " id_documento =\"" . $this->trata_dados($this->id_documento) . "\"";
   }
   //----- decripcion_doc
   function NM_export_decripcion_doc()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->decripcion_doc))
         {
             $this->decripcion_doc = mb_convert_encoding($this->decripcion_doc, "UTF-8");
         }
         $this->xml_registro .= " decripcion_doc =\"" . $this->trata_dados($this->decripcion_doc) . "\"";
   }
   //----- numero
   function NM_export_numero()
   {
         ...
         {
             $this->numero = mb_convert_encoding($this->numero, "UTF-8");
         }
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->punto_vta))
         {
             $this->punto_vta = mb_convert_encoding($this->punto_vta, "UTF-8");
         }
         $this->xml_registro .= " punto_vta =\"" . $this->trata_dados($this->punto_vta) . "\"";
   }
   //----- cantidad_filas
   function NM_export_cantidad_filas()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->cantidad_filas))
         {
             $this->cantidad_filas = mb_convert_encoding($this->cantidad_filas, "UTF-8");
         }
         $this->xml_registro .= " cantidad_filas =\"" . $this->trata_dados($this->cantidad_filas) . "\"";
   }
   //----- control_stock
   function NM_export_control_stock()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_control_stock))
         {
             $this->look_control_stock = mb_convert_encoding($this->look_control_stock, "UTF-8");
         }
         $this->xml_registro .= " control_stock =\"" . $this->trata_dados($this->look_control_stock) . "\"";
   }
   //----- graba_caja
   function NM_export_graba_caja()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_graba_caja))
         {
             $this->look_graba_caja = mb_convert_encoding($this->look_graba_caja, "UTF-8");
         }
         $this->xml_registro .= " graba_caja =\"" . $this->trata_dados($this->look_graba_caja) . "\"";
   }
   //----- graba_cliente_ctacte
   function NM_export_graba_cliente_ctacte()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_graba_cliente_ctacte))
         {
             $this->look_graba_cliente_ctacte = mb_convert_encoding($this->look_graba_cliente_ctacte, "UTF-8");
         }
         $this->xml_registro .= " graba_cliente_ctacte =\"" . $this->trata_dados($this->look_graba_cliente_ctacte) . "\"";
   }
   //----- graba_prov_ctacte
   function NM_export_graba_prov_ctacte()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_graba_prov_ctacte))
         {
             $this->look_graba_prov_ctacte = mb_convert_encoding($this->look_graba_prov_ctacte, "UTF-8");
         }
         $this->xml_registro .= " graba_prov_ctacte =\"" . $this->trata_dados($this->look_graba_prov_ctacte) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_documentos']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_documentos']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - documentos :: XML</TITLE>
