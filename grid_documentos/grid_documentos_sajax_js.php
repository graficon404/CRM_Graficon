  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_documentos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_documentos_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_punto_vta_cond = scAjaxGetFieldSelect("punto_vta_cond");
    var var_punto_vta = scAjaxGetFieldText("punto_vta");
    var var_id_documento_cond = scAjaxGetFieldSelect("id_documento_cond");
    var var_id_documento = scAjaxGetFieldText("id_documento");
    var var_decripcion_doc_cond = scAjaxGetFieldSelect("decripcion_doc_cond");
    var var_decripcion_doc = scAjaxGetFieldText("decripcion_doc");
    var var_numero_cond = scAjaxGetFieldSelect("numero_cond");
    ...
    x_grid_documentos_ajax_save_filter( var_punto_vta_cond, var_punto_vta, var_id_documento_cond, var_id_documento, var_decripcion_doc_cond, var_decripcion_doc, var_numero_cond, var_numero, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_documentos_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_documentos_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_documentos_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_documentos_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_documentos_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_documentos_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_documentos_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_documentos_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_documentos_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_documentos_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "punto_vta";
  ajax_field_list[1] = "id_documento";
  ajax_field_list[2] = "decripcion_doc";
  ajax_field_list[3] = "numero";

  var ajax_error_list = {
    "punto_vta": {"label": "Punto Vta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_documento": {"label": "Id Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "decripcion_doc": {"label": "Decripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "numero": {"label": "Número", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
