...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_documentos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_documentos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_documentos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_documentos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_documentos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_documentos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_documentos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_documentos']['sc_modal']);
