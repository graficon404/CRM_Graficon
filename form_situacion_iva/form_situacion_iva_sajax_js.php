  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_situacion_iva" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_sitiva
  function do_ajax_form_situacion_iva_validate_id_sitiva()
  {
    var nomeCampo_id_sitiva = "id_sitiva";
    var var_id_sitiva = scAjaxGetFieldText(nomeCampo_id_sitiva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_situacion_iva_validate_id_sitiva(var_id_sitiva, var_script_case_init, do_ajax_form_situacion_iva_validate_id_sitiva_cb);
  } // do_ajax_form_situacion_iva_validate_id_sitiva

  function do_ajax_form_situacion_iva_validate_id_sitiva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_sitiva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_situacion_iva_validate_id_sitiva_cb

  // ---------- Validate descripcion
  function do_ajax_form_situacion_iva_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_situacion_iva_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_situacion_iva_validate_descripcion_cb);
  } // do_ajax_form_situacion_iva_validate_descripcion

  function do_ajax_form_situacion_iva_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_situacion_iva_validate_descripcion_cb
  // ---------- Form
  function do_ajax_form_situacion_iva_submit_form()
  {
    scAjaxHideMessage();
    var var_id_sitiva = scAjaxGetFieldText("id_sitiva");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_situacion_iva_submit_form(var_id_sitiva, var_descripcion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_situacion_iva_submit_form_cb);
  } // do_ajax_form_situacion_iva_submit_form

  function do_ajax_form_situacion_iva_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_sitiva");
  ...
  } // do_ajax_form_situacion_iva_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_situacion_iva_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_sitiva");
    scAjaxHideErrorDisplay("descripcion");
    var var_id_sitiva = document.F2.id_sitiva.value;
    ...
    scAjaxProcOn();
    x_ajax_form_situacion_iva_navigate_form(var_id_sitiva, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_situacion_iva_navigate_form_cb);
  } // do_ajax_form_situacion_iva_navigate_form

  function do_ajax_form_situacion_iva_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_sitiva.value = scAjaxGetKeyValue("id_sitiva");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
...
{
?>
    do_ajax_form_situacion_iva_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_situacion_iva_navigate_form_cb
  ...
  var ajax_error_list = {
    "id_sitiva": {"label": "ID Sit IVA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["id_sitiva"][1] = "id_sitiva";
  ajax_field_mult["descripcion"][1] = "descripcion";

  var ajax_field_id = {
    "id_sitiva": new Array("hidden_field_label_id_sitiva", "hidden_field_data_id_sitiva"),
