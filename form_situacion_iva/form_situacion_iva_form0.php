...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - situacion_iva"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - situacion_iva"); } ?></TITLE>
...
<?php
include_once("form_situacion_iva_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_situacion_iva_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['recarga'];
}
?>
...
<?php
 include_once("form_situacion_iva_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_situacion_iva'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_situacion_iva'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - situacion_iva"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_titl'] . " - situacion_iva"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['id_sitiva']))
           {
               $this->nmgp_cmp_readonly['id_sitiva'] = 'on';
           }
?>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['id_sitiva']))
    {
        $this->nm_new_label['id_sitiva'] = "ID Sit IVA";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $id_sitiva = $this->id_sitiva;
   $sStyleHidden_id_sitiva = '';
   if (isset($this->nmgp_cmp_hidden['id_sitiva']) && $this->nmgp_cmp_hidden['id_sitiva'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['id_sitiva']);
       $sStyleHidden_id_sitiva = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_id_sitiva = 'display: none;';
   $sStyleReadInp_id_sitiva = '';
   if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["id_sitiva"]) &&  $this->nmgp_cmp_readonly["id_sitiva"] == "on"))
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['id_sitiva']);
       $sStyleReadLab_id_sitiva = '';
       $sStyleReadInp_id_sitiva = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['id_sitiva']) && $this->nmgp_cmp_hidden['id_sitiva'] == 'off') { $sc_hidden_yes++;  ?>
<input type=hidden name="id_sitiva" value="<?php echo NM_encode_input($id_sitiva) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_id_sitiva" style="<?php echo $sStyleHidden_id_sitiva; ?>;"><span id="id_label_id_sitiva"><?php echo $this->nm_new_label['id_sitiva']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['php_cmp_required']['id_sitiva']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['php_cmp_required']['id_sitiva'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_id_sitiva" style="<?php echo $sStyleHidden_id_sitiva; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["id_sitiva"]) &&  $this->nmgp_cmp_readonly["id_sitiva"] == "on")) { 

 ?>
<input type=hidden name="id_sitiva" value="<?php echo NM_encode_input($id_sitiva) . "\"><span id=\"id_ajax_label_id_sitiva\">" . $id_sitiva . "</span>"; ?>
<?php } else { ?>
<span id="id_read_on_id_sitiva" class="sc-ui-readonly-id_sitiva" style=";<?php echo $sStyleReadLab_id_sitiva; ?>"><?php echo NM_encode_input($this->id_sitiva); ?></span><span id="id_read_off_id_sitiva" style="white-space: nowrap;<?php echo $sStyleReadInp_id_sitiva; ?>">
 <input class="sc-js-input scFormObjectOdd" style="text-align:left;" id="id_sc_field_id_sitiva" type=text name="id_sitiva" value="<?php echo NM_encode_input($id_sitiva) ?>"
 size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['id_sitiva']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['id_sitiva']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_id_sitiva_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_id_sitiva_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_descripcion" style="<?php echo $sStyleHidden_descripcion; ?>;"><span id="id_label_descripcion"><?php echo $this->nm_new_label['descripcion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['php_cmp_required']['descripcion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['php_cmp_required']['descripcion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_situacion_iva']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  }
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_situacion_iva");
 parent.scAjaxDetailHeight("form_situacion_iva", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
