<?php  
  session_start() ;
  class form_situacion_iva_form_teste
  {
   function form_situacion_iva_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_situacion_iva/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_situacion_iva</FONT></B> 
<br> 
...
<input type="submit" value="form_situacion_iva"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_situacion_iva_form_teste();
  $frm_teste->form_situacion_iva_teste();
?>
