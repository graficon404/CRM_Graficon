  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_vendedor" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_vendedor
  function do_ajax_form_vendedor_validate_id_vendedor()
  {
    var nomeCampo_id_vendedor = "id_vendedor";
    var var_id_vendedor = scAjaxGetFieldHidden(nomeCampo_id_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vendedor_validate_id_vendedor(var_id_vendedor, var_script_case_init, do_ajax_form_vendedor_validate_id_vendedor_cb);
  } // do_ajax_form_vendedor_validate_id_vendedor

  function do_ajax_form_vendedor_validate_id_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_vendedor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vendedor_validate_id_vendedor_cb

  // ---------- Validate vendedor
  function do_ajax_form_vendedor_validate_vendedor()
  {
    var nomeCampo_vendedor = "vendedor";
    var var_vendedor = scAjaxGetFieldText(nomeCampo_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vendedor_validate_vendedor(var_vendedor, var_script_case_init, do_ajax_form_vendedor_validate_vendedor_cb);
  } // do_ajax_form_vendedor_validate_vendedor

  function do_ajax_form_vendedor_validate_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vendedor_validate_vendedor_cb

  // ---------- Validate comision
  function do_ajax_form_vendedor_validate_comision()
  {
    var nomeCampo_comision = "comision";
    var var_comision = scAjaxGetFieldText(nomeCampo_comision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vendedor_validate_comision(var_comision, var_script_case_init, do_ajax_form_vendedor_validate_comision_cb);
  } // do_ajax_form_vendedor_validate_comision

  function do_ajax_form_vendedor_validate_comision_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "comision";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vendedor_validate_comision_cb

  // ---------- Validate observaciones
  function do_ajax_form_vendedor_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_vendedor_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_vendedor_validate_observaciones_cb);
  } // do_ajax_form_vendedor_validate_observaciones

  function do_ajax_form_vendedor_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_vendedor_validate_observaciones_cb
  // ---------- Form
  function do_ajax_form_vendedor_submit_form()
  {
    scAjaxHideMessage();
    var var_id_vendedor = scAjaxGetFieldHidden("id_vendedor");
    var var_vendedor = scAjaxGetFieldText("vendedor");
    var var_comision = scAjaxGetFieldText("comision");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_vendedor_submit_form(var_id_vendedor, var_vendedor, var_comision, var_observaciones, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_vendedor_submit_form_cb);
  } // do_ajax_form_vendedor_submit_form

  function do_ajax_form_vendedor_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_vendedor");
      scAjaxHideErrorDisplay("vendedor");
      scAjaxHideErrorDisplay("comision");
  ...
  } // do_ajax_form_vendedor_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_vendedor_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("comision");
    scAjaxHideErrorDisplay("observaciones");
    var var_id_vendedor = document.F2.id_vendedor.value;
    ...
    scAjaxProcOn();
    x_ajax_form_vendedor_navigate_form(var_id_vendedor, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_vendedor_navigate_form_cb);
  } // do_ajax_form_vendedor_navigate_form

  function do_ajax_form_vendedor_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_vendedor.value = scAjaxGetKeyValue("id_vendedor");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
...
{
?>
    do_ajax_form_vendedor_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_vendedor_navigate_form_cb
  ...
  ajax_field_list[0] = "id_vendedor";
  ajax_field_list[1] = "vendedor";
  ajax_field_list[2] = "comision";
  ...
  var ajax_error_list = {
    "id_vendedor": {"label": "Id Vendedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "comision": {"label": "Comision", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id_vendedor": new Array(),
    "vendedor": new Array(),
    "comision": new Array(),
    "observaciones": new Array()
  };
  ajax_field_mult["id_vendedor"][1] = "id_vendedor";
  ajax_field_mult["vendedor"][1] = "vendedor";
  ajax_field_mult["comision"][1] = "comision";
  ajax_field_mult["observaciones"][1] = "observaciones";

  var ajax_field_id = {
    "id_vendedor": new Array("hidden_field_label_id_vendedor", "hidden_field_data_id_vendedor"),
    "vendedor": new Array("hidden_field_label_vendedor", "hidden_field_data_vendedor"),
    "comision": new Array("hidden_field_label_comision", "hidden_field_data_comision"),
