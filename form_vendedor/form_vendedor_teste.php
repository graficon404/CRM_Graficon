<?php  
  session_start() ;
  class form_vendedor_form_teste
  {
   function form_vendedor_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_vendedor/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_vendedor</FONT></B> 
<br> 
...
<input type="submit" value="form_vendedor"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_vendedor_form_teste();
  $frm_teste->form_vendedor_teste();
?>
