<?php  
  session_start() ;
  class form_clientes_ctacte_form_teste
  {
   function form_clientes_ctacte_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_clientes_ctacte/img";
...
<?php
  ...
  $frm_teste = new form_clientes_ctacte_form_teste();
  $frm_teste->form_clientes_ctacte_teste();
?>
