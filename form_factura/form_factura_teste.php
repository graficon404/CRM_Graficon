<?php  
  session_start() ;
  class form_factura_form_teste
  {
   function form_factura_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_factura/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_factura</FONT></B> 
<br> 
...
<input type="submit" value="form_factura"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_factura_form_teste();
  $frm_teste->form_factura_teste();
?>
