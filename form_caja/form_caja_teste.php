<?php  
  session_start() ;
  class form_caja_form_teste
  {
   function form_caja_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_caja/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_caja</FONT></B> 
<br> 
...
<input type="submit" value="form_caja"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_caja_form_teste();
  $frm_teste->form_caja_teste();
?>
