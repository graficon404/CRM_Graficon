...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_clientes_1") . "/form_clientes_1_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_clientes_1']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_clientes_1'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_vendedor") . "/grid_vendedor_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vendedor']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_vendedor'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_depositos") . "/grid_depositos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_depositos']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_depositos'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_rubro") . "/grid_rubro_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_rubro']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_rubro'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_situacion_iva") . "/grid_situacion_iva_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_situacion_iva']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_situacion_iva'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_condicion_venta") . "/grid_condicion_venta_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_condicion_venta']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_condicion_venta'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_formas_pago") . "/grid_formas_pago_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_formas_pago']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_formas_pago'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_documentos") . "/grid_documentos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_documentos']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_documentos'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[10]))
{
 ...
 $nm_var_lab[11] = "Proveedores Cta.Cte.";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[19]))
{
 ...
 $nm_var_lab[20] = "Documentos Comerciales";
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_caja']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_caja']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[0] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=grid_caja&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_4",
        'icon'     => "",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_articulos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_articulos']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[5] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_articulos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[5] . "",
        'id'       => "item_3",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[7] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_15&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[7] . "",
        'id'       => "item_15",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_clientes_1']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_clientes_1']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[8] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_16&sc_apl_menu=form_clientes_1&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[8] . "",
        'id'       => "item_16",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_proveedores']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_proveedores']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[10] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=grid_proveedores&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[10] . "",
        'id'       => "item_17",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vendedor']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vendedor']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[13] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_27&sc_apl_menu=grid_vendedor&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[13] . "",
        'id'       => "item_27",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_depositos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_depositos']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[14] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_26&sc_apl_menu=grid_depositos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[14] . "",
        'id'       => "item_26",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_rubro']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_rubro']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[15] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_22&sc_apl_menu=grid_rubro&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[15] . "",
        'id'       => "item_22",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_situacion_iva']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_situacion_iva']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[16] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_21&sc_apl_menu=grid_situacion_iva&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[16] . "",
        'id'       => "item_21",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_condicion_venta']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_condicion_venta']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[17] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_20&sc_apl_menu=grid_condicion_venta&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[17] . "",
        'id'       => "item_20",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_formas_pago']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_formas_pago']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[18] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_formas_pago&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[18] . "",
        'id'       => "item_23",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_parametros']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_parametros']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[19] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_25&sc_apl_menu=form_parametros&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[19] . "",
        'id'       => "item_25",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_documentos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_documentos']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[20] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_24&sc_apl_menu=grid_documentos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[20] . "",
        'id'       => "item_24",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
