  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_factura_detalle_1" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate articulo_id_
  function do_ajax_form_factura_detalle_1_validate_articulo_id_(iNumLinha)
  {
    var nomeCampo_articulo_id_ = "articulo_id_" + iNumLinha;
    var var_articulo_id_ = scAjaxGetFieldSelect(nomeCampo_articulo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_factura_detalle_1_validate_articulo_id_(var_articulo_id_, iNumLinha, var_script_case_init, do_ajax_form_factura_detalle_1_validate_articulo_id__cb);
  } // do_ajax_form_factura_detalle_1_validate_articulo_id_

  function do_ajax_form_factura_detalle_1_validate_articulo_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "articulo_id_" + iLineNumber;
    }
    else
    {
      sFieldValid = "articulo_id_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "articulo_id_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "articulo_id_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_factura_detalle_1_validate_articulo_id__cb

  // ---------- Validate cantidad_
  function do_ajax_form_factura_detalle_1_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_factura_detalle_1_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_factura_detalle_1_validate_cantidad__cb);
  } // do_ajax_form_factura_detalle_1_validate_cantidad_

  function do_ajax_form_factura_detalle_1_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_factura_detalle_1_validate_cantidad__cb

  // ---------- Validate unidad_
  function do_ajax_form_factura_detalle_1_validate_unidad_(iNumLinha)
  {
    var nomeCampo_unidad_ = "unidad_" + iNumLinha;
    var var_unidad_ = scAjaxGetFieldHidden(nomeCampo_unidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_factura_detalle_1_validate_unidad_(var_unidad_, iNumLinha, var_script_case_init, do_ajax_form_factura_detalle_1_validate_unidad__cb);
  } // do_ajax_form_factura_detalle_1_validate_unidad_

  function do_ajax_form_factura_detalle_1_validate_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_factura_detalle_1_validate_unidad__cb

  // ---------- Validate precio_
  function do_ajax_form_factura_detalle_1_validate_precio_(iNumLinha)
  {
    var nomeCampo_precio_ = "precio_" + iNumLinha;
    var var_precio_ = scAjaxGetFieldHidden(nomeCampo_precio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_factura_detalle_1_validate_precio_(var_precio_, iNumLinha, var_script_case_init, do_ajax_form_factura_detalle_1_validate_precio__cb);
  } // do_ajax_form_factura_detalle_1_validate_precio_

  function do_ajax_form_factura_detalle_1_validate_precio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_factura_detalle_1_validate_precio__cb

  // ---------- Validate importe_
  function do_ajax_form_factura_detalle_1_validate_importe_(iNumLinha)
  {
    var nomeCampo_importe_ = "importe_" + iNumLinha;
    var var_importe_ = scAjaxGetFieldHidden(nomeCampo_importe_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_factura_detalle_1_validate_importe_(var_importe_, iNumLinha, var_script_case_init, do_ajax_form_factura_detalle_1_validate_importe__cb);
  } // do_ajax_form_factura_detalle_1_validate_importe_

  function do_ajax_form_factura_detalle_1_validate_importe__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "importe_" + iLineNumber;
    }
    else
    {
      sFieldValid = "importe_";
    }
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "importe_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "importe_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_factura_detalle_1_validate_importe__cb

  // ---------- Event onblur articulo_id_
  function do_ajax_form_factura_detalle_1_event_articulo_id__onblur(iSeqForm)
  {
    var var_articulo_id_ = scAjaxGetFieldSelect("articulo_id_" + iSeqForm);
    ...
    scAjaxProcOn(true);
    x_ajax_form_factura_detalle_1_event_articulo_id__onblur(var_articulo_id_, var_unidad_, var_precio_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_factura_detalle_1_event_articulo_id__onblur_cb);
  } // do_ajax_form_factura_detalle_1_event_articulo_id__onblur

  function do_ajax_form_factura_detalle_1_event_articulo_id__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_factura_detalle_1_event_articulo_id__onblur_cb

  // ---------- Event onblur cantidad_
  function do_ajax_form_factura_detalle_1_event_cantidad__onblur(iSeqForm)
  {
    var var_importe_ = scAjaxGetFieldHidden("importe_" + iSeqForm);
    var var_precio_ = scAjaxGetFieldHidden("precio_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_factura_detalle_1_event_cantidad__onblur(var_importe_, var_precio_, var_cantidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_factura_detalle_1_event_cantidad__onblur_cb);
  } // do_ajax_form_factura_detalle_1_event_cantidad__onblur

  function do_ajax_form_factura_detalle_1_event_cantidad__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_factura_detalle_1_event_cantidad__onblur_cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_factura_detalle_1_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_factura_detalle_1_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_factura_detalle_1_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_factura_detalle_1_add_new_line_cb);
  } // do_ajax_form_factura_detalle_1_add_new_line

  function do_ajax_form_factura_detalle_1_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_factura_detalle_1_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_factura_detalle_1_backup_line(iNumLinha)
  {
    var var_id_fact_detalle_ = scAjaxGetFieldText("id_fact_detalle_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_factura_detalle_1_backup_line(var_id_fact_detalle_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_factura_detalle_1_backup_line_cb);
  } // do_ajax_form_factura_detalle_1_backup_line

  function do_ajax_form_factura_detalle_1_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_factura_detalle_1_backup_line_cb

  function do_ajax_form_factura_detalle_1_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_factura_detalle_1_cancel_insert

  function do_ajax_form_factura_detalle_1_cancel_update(iSeqVert)
  {
    do_ajax_form_factura_detalle_1_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_factura_detalle_1_cancel_update

  function do_ajax_form_factura_detalle_1_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_factura_detalle_1_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_factura_detalle_1_table_refresh()
  {
    var var_id_fact_detalle_ = document.F2.id_fact_detalle_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    var var_nmgp_ordem = document.F2.nmgp_ordem.value;
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_factura_detalle_1_table_refresh(var_id_fact_detalle_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_factura_detalle_1_table_refresh_cb);
  } //  do_ajax_form_factura_detalle_1_table_refresh

  function do_ajax_form_factura_detalle_1_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.id_fact_detalle_.value = scAjaxGetKeyValue("id_fact_detalle_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_factura_detalle_1_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_factura_detalle_1_submit_form(iNumLinha, indexTR)
  {
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_articulo_id_ = scAjaxGetFieldSelect("articulo_id_" + iNumLinha);
    ...
    var var_importe_ = scAjaxGetFieldHidden("importe_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_factura_detalle_1_submit_form(var_articulo_id_, var_cantidad_, var_unidad_, var_precio_, var_importe_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_factura_detalle_1_submit_form_cb);
  } // do_ajax_form_factura_detalle_1_submit_form

  function do_ajax_form_factura_detalle_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("articulo_id_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("importe_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_factura_detalle_1_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_factura_detalle_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_factura_detalle_1_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_factura_detalle_1_navigate_form(var_id_fact_detalle_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_script_case_init, do_ajax_form_factura_detalle_1_navigate_form_cb);
  } // do_ajax_form_factura_detalle_1_navigate_form

  function do_ajax_form_factura_detalle_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_fact_detalle_.value = scAjaxGetKeyValue("id_fact_detalle_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_factura_detalle_1_navigate_form_cb
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "articulo_id_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "importe_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["articulo_id_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_factura_detalle_fld_articulo_id'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cantidad_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_factura_detalle_fld_cantidad'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["unidad_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_factura_detalle_fld_Unidad'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["precio_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_factura_detalle_fld_precio'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["importe_" + iNumLinha] = {"label": "<?php echo $this->Ini->Nm_lang['lang_factura_detalle_fld_Importe'] ?><?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["articulo_id_"][iNumLinha] = "articulo_id_" + iNumLinha;
    ...
    ajax_field_mult["importe_"][iNumLinha] = "importe_" + iNumLinha;
    ajax_field_id["articulo_id_" + iNumLinha] = new Array("hidden_field_label_articulo_id_", "hidden_field_data_articulo_id_" + iNumLinha);
...
?>
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["articulo_id_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["articulo_id_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["articulo_id_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["articulo_id_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["articulo_id_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["importe_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["importe_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["importe_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["importe_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["importe_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['articulo_id_'])) ? $this->nmgp_cmp_readonly['articulo_id_'] : 'off';
?>
    scAjaxFieldRead("articulo_id_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['importe_'])) ? $this->nmgp_cmp_readonly['importe_'] : 'off';
?>
    scAjaxFieldRead("importe_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("articulo_id_" + iSeq, "on");
    scAjaxFieldRead("cantidad_" + iSeq, "on");
    scAjaxFieldRead("unidad_" + iSeq, "on");
    scAjaxFieldRead("precio_" + iSeq, "on");
    scAjaxFieldRead("importe_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["articulo_id_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["unidad_" + iRow] || "on" == ajax_error_count["precio_" + iRow] || "on" == ajax_error_count["importe_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_articulo_id_" + iRow))
        document.getElementById("hidden_field_data_articulo_id_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_cantidad_" + iRow))
        document.getElementById("hidden_field_data_cantidad_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_unidad_" + iRow))
        document.getElementById("hidden_field_data_unidad_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_precio_" + iRow))
        document.getElementById("hidden_field_data_precio_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_importe_" + iRow))
        document.getElementById("hidden_field_data_importe_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["articulo_id_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["unidad_" + iRow] && "off" == ajax_error_count["precio_" + iRow] && "off" == ajax_error_count["importe_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["articulo_id_" + iRow] = "off";
        ajax_error_count["cantidad_" + iRow] = "off";
        ajax_error_count["unidad_" + iRow] = "off";
        ajax_error_count["precio_" + iRow] = "off";
        ajax_error_count["importe_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_articulo_id_" + iRow))
        document.getElementById("hidden_field_data_articulo_id_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_cantidad_" + iRow))
        document.getElementById("hidden_field_data_cantidad_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_unidad_" + iRow))
        document.getElementById("hidden_field_data_unidad_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_precio_" + iRow))
        document.getElementById("hidden_field_data_precio_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_importe_" + iRow))
        document.getElementById("hidden_field_data_importe_" + iRow).className = sCssLine;
    }
  }
