<?php  
  session_start() ;
  class form_factura_detalle_1_form_teste
  {
   function form_factura_detalle_1_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_factura_detalle_1/img";
...
<?php
  ...
  $frm_teste = new form_factura_detalle_1_form_teste();
  $frm_teste->form_factura_detalle_1_teste();
?>
