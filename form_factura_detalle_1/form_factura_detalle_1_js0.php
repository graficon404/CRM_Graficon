<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type=hidden name="id_fact_detalle_" value="<?php echo NM_encode_input($this->nmgp_dados_form['id_fact_detalle_']); ?>">
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_factura_detalle_1_submit_form(y, z); 
} 
<?php
}
?>
