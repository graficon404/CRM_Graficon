<?php  
  session_start() ;
  class form_depositos_form_teste
  {
   function form_depositos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_depositos/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_depositos</FONT></B> 
<br> 
...
<input type="submit" value="form_depositos"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_depositos_form_teste();
  $frm_teste->form_depositos_teste();
?>
