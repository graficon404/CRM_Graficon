<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type=hidden name="id_depositos" value="<?php echo NM_encode_input($this->nmgp_dados_form['id_depositos']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_depositos']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[1] = new NM_critica('F1', 'deposito', 'Deposito', 'naomask', 'lista', 'cxab', 30, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'direccion', 'Direccion', 'naomask', 'lista', 'cxab', 30, 'TUDO');
 NM_tab_crit[3] = new NM_critica('F1', 'cod_postal', 'Cod Postal', 'naomask', 'lista', 'cxab', 8, 'TUDO');
 NM_tab_crit[4] = new NM_critica('F1', 'localidad', 'Localidad', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit[5] = new NM_critica('F1', 'provincia', 'Provincia', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit[6] = new NM_critica('F1', 'sc_field_0', 'Teléfono', 'naomask', 'lista', 'cxab', 15, 'TUDO');
 NM_tab_crit[7] = new NM_critica('F1', 'responsable', 'Responsable', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit[8] = new NM_critica('F1', 'observaciones', 'Observaciones', 'naomask', 'lista', 'cxab', 32767, 'TUDO');
 NM_tab_crit[9] = new NM_critica('NM_final');
 NM_tab_crit_1 = new NM_critica(9);
 NM_tab_crit_1[1] = new NM_critica('F1', 'deposito', 'Deposito', 'naomask', 'lista', 'cxab', 30, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'direccion', 'Direccion', 'naomask', 'lista', 'cxab', 30, 'TUDO');
 NM_tab_crit_1[3] = new NM_critica('F1', 'cod_postal', 'Cod Postal', 'naomask', 'lista', 'cxab', 8, 'TUDO');
 NM_tab_crit_1[4] = new NM_critica('F1', 'localidad', 'Localidad', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit_1[5] = new NM_critica('F1', 'provincia', 'Provincia', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit_1[6] = new NM_critica('F1', 'sc_field_0', 'Teléfono', 'naomask', 'lista', 'cxab', 15, 'TUDO');
 NM_tab_crit_1[7] = new NM_critica('F1', 'responsable', 'Responsable', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit_1[8] = new NM_critica('F1', 'observaciones', 'Observaciones', 'naomask', 'lista', 'cxab', 32767, 'TUDO');
