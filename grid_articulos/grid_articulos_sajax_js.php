  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_articulos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_articulos_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_descripcion_cond = scAjaxGetFieldSelect("descripcion_cond");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_id_articulo_cond = scAjaxGetFieldSelect("id_articulo_cond");
    var var_id_articulo = scAjaxGetFieldText("id_articulo");
    var var_codigo_barra_cond = scAjaxGetFieldSelect("codigo_barra_cond");
    var var_codigo_barra = scAjaxGetFieldText("codigo_barra");
    var var_rubro_id_cond = scAjaxGetFieldSelect("rubro_id_cond");
    ...
    x_grid_articulos_ajax_save_filter( var_descripcion_cond, var_descripcion, var_id_articulo_cond, var_id_articulo, var_codigo_barra_cond, var_codigo_barra, var_rubro_id_cond, var_rubro_id, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_articulos_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_articulos_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_articulos_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_articulos_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_articulos_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_articulos_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_articulos_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_articulos_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_articulos_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_articulos_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[1] = "id_articulo";
  ajax_field_list[2] = "codigo_barra";
  ajax_field_list[3] = "rubro_id";

  var ajax_error_list = {
    "descripcion": {"label": "{lang_articulos_fld_Descripcion}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_articulo": {"label": "{lang_articulos_fld_id_articulo}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "codigo_barra": {"label": "{lang_articulos_fld_Codigo_barra}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "rubro_id": {"label": "{lang_articulos_fld_rubro_id}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
