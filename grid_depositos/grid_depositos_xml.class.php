...
class grid_depositos_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_depositos.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_depositos";
   ...
   function NM_export_id_depositos()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_depositos))
         {
             $this->id_depositos = mb_convert_encoding($this->id_depositos, "UTF-8");
         }
         $this->xml_registro .= " id_depositos =\"" . $this->trata_dados($this->id_depositos) . "\"";
   }
   //----- deposito
   function NM_export_deposito()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->deposito))
         {
             $this->deposito = mb_convert_encoding($this->deposito, "UTF-8");
         }
         $this->xml_registro .= " deposito =\"" . $this->trata_dados($this->deposito) . "\"";
   }
   //----- direccion
   ...
   function NM_export_responsable()
   {
         ...
         {
             $this->responsable = mb_convert_encoding($this->responsable, "UTF-8");
         }
         $this->xml_registro .= " responsable =\"" . $this->trata_dados($this->responsable) . "\"";
   }
   //----- sc_field_0
   function NM_export_sc_field_0()
   {
         ...
         $this->xml_registro .= " Teléfono =\"" . $this->trata_dados($this->sc_field_0) . "\"";
   }
   //----- observaciones
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - depositos :: XML</TITLE>
