  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_depositos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_depositos_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_cod_postal_cond = scAjaxGetFieldSelect("cod_postal_cond");
    var var_cod_postal = scAjaxGetFieldText("cod_postal");
    var var_id_depositos_cond = scAjaxGetFieldSelect("id_depositos_cond");
    var var_id_depositos = scAjaxGetFieldText("id_depositos");
    var var_deposito_cond = scAjaxGetFieldSelect("deposito_cond");
    var var_deposito = scAjaxGetFieldText("deposito");
    var var_direccion_cond = scAjaxGetFieldSelect("direccion_cond");
    ...
    x_grid_depositos_ajax_save_filter( var_cod_postal_cond, var_cod_postal, var_id_depositos_cond, var_id_depositos, var_deposito_cond, var_deposito, var_direccion_cond, var_direccion, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_depositos_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_depositos_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_depositos_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_depositos_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_depositos_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_depositos_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_depositos_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_depositos_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_depositos_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_depositos_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "cod_postal";
  ajax_field_list[1] = "id_depositos";
  ajax_field_list[2] = "deposito";
  ajax_field_list[3] = "direccion";

  var ajax_error_list = {
    "cod_postal": {"label": "Cod Postal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_depositos": {"label": "Id Depositos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "deposito": {"label": "Deposito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "direccion": {"label": "Direccion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
