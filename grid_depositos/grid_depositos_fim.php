...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_depositos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_depositos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_depositos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_depositos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_depositos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_depositos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_depositos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_depositos']['sc_modal']);
