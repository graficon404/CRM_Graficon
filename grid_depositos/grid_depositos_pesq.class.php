...
class grid_depositos_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   {
      global 
      $cod_postal_cond, $cod_postal,
             $id_depositos_cond, $id_depositos,
             $deposito_cond, $deposito,
             $direccion_cond, $direccion,
      $NM_filters, $NM_filters_del, $nmgp_save_name, $NM_operador, $nmgp_save_option, $bprocessa, $Ajax_label, $Ajax_val, $Campo_bi, $Opc_bi;
      $this->init();
      if (isset($this->NM_ajax_info['param']['cod_postal_cond']))
      {
          $cod_postal_cond = $this->NM_ajax_info['param']['cod_postal_cond'];
      }
      if (isset($this->NM_ajax_info['param']['cod_postal']))
      {
          $cod_postal = $this->NM_ajax_info['param']['cod_postal'];
      }
      if (isset($this->NM_ajax_info['param']['id_depositos_cond']))
      {
          $id_depositos_cond = $this->NM_ajax_info['param']['id_depositos_cond'];
      }
      if (isset($this->NM_ajax_info['param']['id_depositos']))
      {
          $id_depositos = $this->NM_ajax_info['param']['id_depositos'];
      }
      if (isset($this->NM_ajax_info['param']['deposito_cond']))
      {
          $deposito_cond = $this->NM_ajax_info['param']['deposito_cond'];
      }
      if (isset($this->NM_ajax_info['param']['deposito']))
      {
          $deposito = $this->NM_ajax_info['param']['deposito'];
      }
      if (isset($this->NM_ajax_info['param']['direccion_cond']))
      {
          $direccion_cond = $this->NM_ajax_info['param']['direccion_cond'];
      }
      if (isset($this->NM_ajax_info['param']['direccion']))
      {
          $direccion = $this->NM_ajax_info['param']['direccion'];
      }
      ...
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_depositos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_depositos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_depositos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - depositos</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_depositos_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_depositos_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_depositos_do_ajax_delete_filter(pos);
 }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - depositos</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cod_postal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['cod_postal']; 
          $cod_postal_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['cod_postal_cond']; 
          $id_depositos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['id_depositos']; 
          $id_depositos_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['id_depositos_cond']; 
          $deposito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['deposito']; 
          $deposito_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['deposito_cond']; 
          $direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['direccion']; 
          $direccion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['direccion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['NM_operador']; 
          if (strtoupper($id_depositos_cond) != "II" && strtoupper($id_depositos_cond) != "QP" && strtoupper($id_depositos_cond) != "NP" && strtoupper($id_depositos_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_depositos, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($cod_postal_cond) || empty($cod_postal_cond))
      {
         $cod_postal_cond = "eq";
      }
      if (!isset($id_depositos_cond) || empty($id_depositos_cond))
      {
         $id_depositos_cond = "eq";
      }
      if (!isset($deposito_cond) || empty($deposito_cond))
      {
         $deposito_cond = "eq";
      }
      ...
      if (!isset($localidad_cond) || empty($localidad_cond))
      {
         $localidad_cond = "eq";
      }
      if (!isset($provincia_cond) || empty($provincia_cond))
      {
         $provincia_cond = "eq";
      }
      ...
      if (!isset($responsable_cond) || empty($responsable_cond))
      {
         $responsable_cond = "eq";
      }
      ...
      if (!isset($cod_postal) || $cod_postal == "")
      {
          $cod_postal = "";
      }
      if (isset($cod_postal) && !empty($cod_postal))
      {
         $tmp_pos = strpos($cod_postal, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cod_postal = substr($cod_postal, 0, $tmp_pos);
         }
      }
      if (!isset($id_depositos) || $id_depositos == "")
      {
          $id_depositos = "";
      }
      if (isset($id_depositos) && !empty($id_depositos))
      {
         $tmp_pos = strpos($id_depositos, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_depositos = substr($id_depositos, 0, $tmp_pos);
         }
      }
      if (!isset($deposito) || $deposito == "")
      {
          $deposito = "";
      }
      if (isset($deposito) && !empty($deposito))
      {
         $tmp_pos = strpos($deposito, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $deposito = substr($deposito, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_depositos_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['cod_postal'])) ? $this->New_label['cod_postal'] : "Cod Postal"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="cod_postal_cond">
       <OPTION value="eq" <?php if ("eq" == $cod_postal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $cod_postal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $cod_postal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $cod_postal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
 ...
 $nmgp_tab_label .= "cod_postal?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_cod_postal" name="cod_postal" value="<?php echo NM_encode_input($cod_postal) ?>" size=8 alt="{datatype: 'text', maxLength: 8, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_depositos'])) ? $this->New_label['id_depositos'] : "Id Depositos"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="id_depositos_cond">
       <OPTION value="eq" <?php if ("eq" == $id_depositos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $id_depositos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_depositos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $id_depositos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "id_depositos?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_id_depositos" name="id_depositos" value="<?php echo NM_encode_input($id_depositos) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['deposito'])) ? $this->New_label['deposito'] : "Deposito"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="deposito_cond">
       <OPTION value="eq" <?php if ("eq" == $deposito_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $deposito_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $deposito_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $deposito_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "deposito?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_deposito" name="deposito" value="<?php echo NM_encode_input($deposito) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['direccion'])) ? $this->New_label['direccion'] : "Direccion"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="direccion_cond">
       <OPTION value="eq" <?php if ("eq" == $direccion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $direccion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $direccion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $direccion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_direccion" name="direccion" value="<?php echo NM_encode_input($direccion) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_depositos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_depositos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.cod_postal.value = "";
   document.F1.id_depositos.value = "";
   document.F1.deposito.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "CRM_Graficon/grid_depositos";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_depositos']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      if (isset($nmgp_save_name) && !empty($nmgp_save_name))
      { 
          if ($id_depositos_cond != "in")
          {
              nm_limpa_numero($id_depositos, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $id_depositos);
              ...
              $id_depositos = implode(",", $Nm_sc_valores);
          }
          ...
          $NM_temp  = (isset($cod_postal_cond)) ? $cod_postal_cond : ""; 
          $NM_str_filter .= "cod_postal_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($cod_postal)) ? $cod_postal : ""; 
          $NM_str_filter .= "cod_postal#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_depositos_cond)) ? $id_depositos_cond : ""; 
          $NM_str_filter .= "id_depositos_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_depositos)) ? $id_depositos : ""; 
          $NM_str_filter .= "id_depositos#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($deposito_cond)) ? $deposito_cond : ""; 
          $NM_str_filter .= "deposito_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($deposito)) ? $deposito : ""; 
          $NM_str_filter .= "deposito#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($direccion_cond)) ? $direccion_cond : ""; 
          $NM_str_filter .= "direccion_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($direccion)) ? $direccion : ""; 
          $NM_str_filter .= "direccion#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_depositos']['path_libs_php'] . "/nm_edit.php");
      }
      $sc_conv_var = array();
      $Look_man = array();
      $tp_html['cod_postal_cond'] = 'select';
      $tp_html['id_depositos_cond'] = 'select';
      $tp_html['deposito_cond'] = 'select';
      $tp_html['direccion_cond'] = 'select';
      $tp_html['cod_postal'] = 'text';
      $tp_html['id_depositos'] = 'text';
      $tp_html['deposito'] = 'text';
      $tp_html['direccion'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "id_depositos_cond"))
                  {
                      $$Cada_cmp[0] = trim($Cada_cmp[1]);
                  }
                  if ($SC_V6 && $Cada_cmp[0] == "id_depositos")
                  {
                      if (strtoupper($id_depositos_cond) != "II" && strtoupper($id_depositos_cond) != "QP" && strtoupper($id_depositos_cond) != "NP" && strtoupper($id_depositos_cond) != "IN") 
                      { 
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = grid_depositos_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_depositos_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $cod_postal_cond, $cod_postal,
             $id_depositos_cond, $id_depositos,
             $deposito_cond, $deposito,
             $direccion_cond, $direccion, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $cod_postal_cond_salva = $cod_postal_cond; 
      if (!isset($cod_postal_input_2) || $cod_postal_input_2 == "")
      {
          $cod_postal_input_2 = $cod_postal;
      }
      $id_depositos_cond_salva = $id_depositos_cond; 
      if (!isset($id_depositos_input_2) || $id_depositos_input_2 == "")
      {
          $id_depositos_input_2 = $id_depositos;
      }
      $deposito_cond_salva = $deposito_cond; 
      if (!isset($deposito_input_2) || $deposito_input_2 == "")
      {
          $deposito_input_2 = $deposito;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['cod_postal'] = $cod_postal; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['cod_postal_cond'] = $cod_postal_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['id_depositos'] = $id_depositos; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['id_depositos_cond'] = $id_depositos_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['deposito'] = $deposito; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['deposito_cond'] = $deposito_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['direccion'] = $direccion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['direccion_cond'] = $direccion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $cod_postal;
      $this->cmp_formatado['cod_postal'] = $Conteudo;
      $Conteudo = $id_depositos;
      if (strtoupper($id_depositos_cond) != "II" && strtoupper($id_depositos_cond) != "QP" && strtoupper($id_depositos_cond) != "NP" && strtoupper($id_depositos_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_depositos'] = $Conteudo;
      $Conteudo = $deposito;
      $this->cmp_formatado['deposito'] = $Conteudo;
      $Conteudo = $direccion;
      $this->cmp_formatado['direccion'] = $Conteudo;

      //----- $cod_postal
      if (isset($cod_postal) || $cod_postal_cond == "nu" || $cod_postal_cond == "nn")
      {
         $this->monta_condicao("Cod_Postal", $cod_postal_cond, $cod_postal, "", "cod_postal");
      }

      //----- $id_depositos
      if (isset($id_depositos) || $id_depositos_cond == "nu" || $id_depositos_cond == "nn")
      {
         $this->monta_condicao("id_depositos", $id_depositos_cond, $id_depositos, "", "id_depositos");
      }

      //----- $deposito
      if (isset($deposito) || $deposito_cond == "nu" || $deposito_cond == "nn")
      {
         $this->monta_condicao("Deposito", $deposito_cond, $deposito, "", "deposito");
      }

      //----- $direccion
      if (isset($direccion) || $direccion_cond == "nu" || $direccion_cond == "nn")
      {
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_depositos']['where_pesq_ant'] = $this->comando . $this->comando_fim;
