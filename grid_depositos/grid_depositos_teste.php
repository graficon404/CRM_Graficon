<?php  
  ...
  session_start() ;
  class grid_depositos_form_teste
  {
  function grid_depositos_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_depositos</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_depositos"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_depositos_form_teste();
  $frm_teste->grid_depositos_teste();
?>
