<?php  
  session_start() ;
  class form_parametros_form_teste
  {
   function form_parametros_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_parametros/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_parametros</FONT></B> 
<br> 
...
<input type="submit" value="form_parametros"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_parametros_form_teste();
  $frm_teste->form_parametros_teste();
?>
