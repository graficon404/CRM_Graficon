<?php  
  session_start() ;
  class form_rubro_form_teste
  {
   function form_rubro_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_rubro/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_rubro</FONT></B> 
<br> 
...
<input type="submit" value="form_rubro"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_rubro_form_teste();
  $frm_teste->form_rubro_teste();
?>
