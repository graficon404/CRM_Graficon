  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_rubro" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_rubro
  function do_ajax_form_rubro_validate_id_rubro()
  {
    var nomeCampo_id_rubro = "id_rubro";
    var var_id_rubro = scAjaxGetFieldHidden(nomeCampo_id_rubro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rubro_validate_id_rubro(var_id_rubro, var_script_case_init, do_ajax_form_rubro_validate_id_rubro_cb);
  } // do_ajax_form_rubro_validate_id_rubro

  function do_ajax_form_rubro_validate_id_rubro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_rubro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rubro_validate_id_rubro_cb

  // ---------- Validate descripcion_rubro
  function do_ajax_form_rubro_validate_descripcion_rubro()
  {
    var nomeCampo_descripcion_rubro = "descripcion_rubro";
    var var_descripcion_rubro = scAjaxGetFieldText(nomeCampo_descripcion_rubro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_rubro_validate_descripcion_rubro(var_descripcion_rubro, var_script_case_init, do_ajax_form_rubro_validate_descripcion_rubro_cb);
  } // do_ajax_form_rubro_validate_descripcion_rubro

  function do_ajax_form_rubro_validate_descripcion_rubro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "descripcion_rubro";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_rubro_validate_descripcion_rubro_cb
  // ---------- Form
  function do_ajax_form_rubro_submit_form()
  {
    scAjaxHideMessage();
    var var_id_rubro = scAjaxGetFieldHidden("id_rubro");
    var var_descripcion_rubro = scAjaxGetFieldText("descripcion_rubro");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_rubro_submit_form(var_id_rubro, var_descripcion_rubro, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_rubro_submit_form_cb);
  } // do_ajax_form_rubro_submit_form

  function do_ajax_form_rubro_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_rubro");
      scAjaxHideErrorDisplay("descripcion_rubro");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_rubro_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_rubro_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_rubro");
    scAjaxHideErrorDisplay("descripcion_rubro");
    var var_id_rubro = document.F2.id_rubro.value;
    ...
    scAjaxProcOn();
    x_ajax_form_rubro_navigate_form(var_id_rubro, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_rubro_navigate_form_cb);
  } // do_ajax_form_rubro_navigate_form

  function do_ajax_form_rubro_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_rubro.value = scAjaxGetKeyValue("id_rubro");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
...
{
?>
    do_ajax_form_rubro_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_rubro_navigate_form_cb
  ...
  ajax_field_list[0] = "id_rubro";
  ajax_field_list[1] = "descripcion_rubro";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_rubro": {"label": "Id Rubro", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descripcion_rubro": {"label": "Descripcion Rubro", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_rubro": new Array(),
    "descripcion_rubro": new Array()
  };
  ajax_field_mult["id_rubro"][1] = "id_rubro";
  ajax_field_mult["descripcion_rubro"][1] = "descripcion_rubro";

  var ajax_field_id = {
    "id_rubro": new Array("hidden_field_label_id_rubro", "hidden_field_data_id_rubro"),
    "descripcion_rubro": new Array("hidden_field_label_descripcion_rubro", "hidden_field_data_descripcion_rubro")
  };

  var ajax_read_only = {
    "id_rubro": "on",
    "descripcion_rubro": "off"
  };
