<?php  
  ...
  session_start() ;
  class grid_rubro_form_teste
  {
  function grid_rubro_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_rubro</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_rubro"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_rubro_form_teste();
  $frm_teste->grid_rubro_teste();
?>
