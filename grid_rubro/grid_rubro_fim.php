...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_rubro"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_rubro"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_rubro'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rubro']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_rubro']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rubro']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_rubro']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_rubro']['sc_modal']);
