<?php  
  session_start() ;
  class form_documentos_form_teste
  {
   function form_documentos_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_documentos/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_documentos</FONT></B> 
<br> 
...
<input type="submit" value="form_documentos"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_documentos_form_teste();
  $frm_teste->form_documentos_teste();
?>
