<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type=hidden name="id_documento" value="<?php echo NM_encode_input($this->nmgp_dados_form['id_documento']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_documentos']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit = new NM_critica(9);
 NM_tab_crit[1] = new NM_critica('F1', 'decripcion_doc', 'decripcion_doc', 'naomask', 'lista', 'cxab', 15, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'numero', 'numero', 'naomask', 'numeroedt', 12, -0, 999999999999, '<?php echo str_replace("'", "\'", $this->field_config['numero']['symbol_grp']); ?>');
 NM_tab_crit[3] = new NM_critica('F1', 'punto_vta', 'punto_vta', 'naomask', 'lista', 'cxab', 4, 'TUDO');
 NM_tab_crit[4] = new NM_critica('F1', 'cantidad_filas', 'cantidad_filas', 'naomask', 'numeroedt', 4, -0, 9999, '<?php echo str_replace("'", "\'", $this->field_config['cantidad_filas']['symbol_grp']); ?>');
 NM_tab_crit[5] = new NM_critica('F1', 'control_stock', 'control_stock', 'naomask', 'numeroedt', 1, -0, 9, '<?php echo str_replace("'", "\'", $this->field_config['control_stock']['symbol_grp']); ?>');
 NM_tab_crit[6] = new NM_critica('F1', 'graba_caja', 'graba_caja', 'naomask', 'numeroedt', 1, -0, 9, '<?php echo str_replace("'", "\'", $this->field_config['graba_caja']['symbol_grp']); ?>');
 NM_tab_crit[7] = new NM_critica('F1', 'graba_cliente_ctacte', 'graba_cliente_ctacte', 'naomask', 'numeroedt', 1, -0, 9, '<?php echo str_replace("'", "\'", $this->field_config['graba_cliente_ctacte']['symbol_grp']); ?>');
 NM_tab_crit[8] = new NM_critica('F1', 'graba_prov_ctacte', 'graba_prov_ctacte', 'naomask', 'numeroedt', 1, -0, 9, '<?php echo str_replace("'", "\'", $this->field_config['graba_prov_ctacte']['symbol_grp']); ?>');
 NM_tab_crit[9] = new NM_critica('NM_final');
 NM_tab_crit_1 = new NM_critica(9);
 NM_tab_crit_1[1] = new NM_critica('F1', 'decripcion_doc', 'decripcion_doc', 'naomask', 'lista', 'cxab', 15, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'numero', 'numero', 'naomask', 'numeroedt', 12, -0, 999999999999, '<?php echo str_replace("'", "\'", $this->field_config['numero']['symbol_grp']); ?>');
 NM_tab_crit_1[3] = new NM_critica('F1', 'punto_vta', 'punto_vta', 'naomask', 'lista', 'cxab', 4, 'TUDO');
 NM_tab_crit_1[4] = new NM_critica('F1', 'cantidad_filas', 'cantidad_filas', 'naomask', 'numeroedt', 4, -0, 9999, '<?php echo str_replace("'", "\'", $this->field_config['cantidad_filas']['symbol_grp']); ?>');
 NM_tab_crit_1[5] = new NM_critica('F1', 'control_stock', 'control_stock', 'naomask', 'numeroedt', 1, -0, 9, '<?php echo str_replace("'", "\'", $this->field_config['control_stock']['symbol_grp']); ?>');
 NM_tab_crit_1[6] = new NM_critica('F1', 'graba_caja', 'graba_caja', 'naomask', 'numeroedt', 1, -0, 9, '<?php echo str_replace("'", "\'", $this->field_config['graba_caja']['symbol_grp']); ?>');
 NM_tab_crit_1[7] = new NM_critica('F1', 'graba_cliente_ctacte', 'graba_cliente_ctacte', 'naomask', 'numeroedt', 1, -0, 9, '<?php echo str_replace("'", "\'", $this->field_config['graba_cliente_ctacte']['symbol_grp']); ?>');
 NM_tab_crit_1[8] = new NM_critica('F1', 'graba_prov_ctacte', 'graba_prov_ctacte', 'naomask', 'numeroedt', 1, -0, 9, '<?php echo str_replace("'", "\'", $this->field_config['graba_prov_ctacte']['symbol_grp']); ?>');
 NM_tab_crit_1[9] = new NM_critica('NM_final');
