...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____form_documentos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____form_documentos"]);
   }
   ...
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_documentos']))
   {
      unset($_SESSION['sc_session'][$script_case_init]['form_documentos']['sc_redir_atualiz']);
      unset($_SESSION['sc_session'][$script_case_init]['form_documentos']['sc_redir_insert']);
   }
   $fecha_janela = false;
   if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_documentos']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['form_documentos']['sc_outra_jan'])
   {
       $fecha_janela = true;
   }
   if ((isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_documentos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['form_documentos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && !is_array($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_documentos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['form_documentos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['form_documentos']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['form_documentos']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_documentos']['db_changed'])
           {
       ...
       {
           if (!isset($script_case_init) || is_array($script_case_init) || !isset($_SESSION['sc_session'][$script_case_init]['form_documentos']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_documentos']['db_changed'])
           {
