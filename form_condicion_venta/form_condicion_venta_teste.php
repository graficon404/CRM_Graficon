<?php  
  session_start() ;
  class form_condicion_venta_form_teste
  {
   function form_condicion_venta_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_condicion_venta/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_condicion_venta</FONT></B> 
<br> 
...
<input type="submit" value="form_condicion_venta"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_condicion_venta_form_teste();
  $frm_teste->form_condicion_venta_teste();
?>
