...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['codigo_barra']))
          {
              $this->codigo_barra = $this->NM_ajax_info['param']['codigo_barra'];
          }
          if (isset($this->NM_ajax_info['param']['coeficiente_ctdo']))
          {
              $this->coeficiente_ctdo = $this->NM_ajax_info['param']['coeficiente_ctdo'];
          }
          if (isset($this->NM_ajax_info['param']['costo']))
          {
              $this->costo = $this->NM_ajax_info['param']['costo'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['id_articulo']))
          {
              $this->id_articulo = $this->NM_ajax_info['param']['id_articulo'];
          }
          if (isset($this->NM_ajax_info['param']['iva']))
          {
              $this->iva = $this->NM_ajax_info['param']['iva'];
          }
          if (isset($this->NM_ajax_info['param']['lista_precio']))
          {
              $this->lista_precio = $this->NM_ajax_info['param']['lista_precio'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['rubro_id']))
          {
              $this->rubro_id = $this->NM_ajax_info['param']['rubro_id'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['stock_minimo']))
          {
              $this->stock_minimo = $this->NM_ajax_info['param']['stock_minimo'];
          }
      ...
      $this->Db = $this->Ini->Db; 
      $this->nm_new_label['codigo_barra'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Codigo_barra'] . '';
      $this->nm_new_label['rubro_id'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_rubro_id'] . '';
      $this->nm_new_label['descripcion'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Descripcion'] . '';
      $this->nm_new_label['unidad'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_unidad'] . '';
      $this->nm_new_label['costo'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Costo'] . '';
      $this->nm_new_label['coeficiente_ctdo'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Coeficiente_Ctdo'] . '';
      $this->nm_new_label['iva'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_IVA'] . '';
      $this->nm_new_label['precio'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Precio'] . '';
      $this->nm_new_label['stock'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Stock'] . '';
      $this->nm_new_label['stock_minimo'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Stock_minimo'] . '';
      $this->nm_new_label['deposito'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Deposito'] . '';
      $this->nm_new_label['ubicacion'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Ubicacion'] . '';
      $this->nm_new_label['activo'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Activo'] . '';
      $this->nm_new_label['lista_precio'] = '' . $this->Ini->Nm_lang['lang_articulos_fld_Lista_precio'] . '';
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['dados_form']))
      {
          ...
          if (!isset($this->id_articulo)){$this->id_articulo = $this->nmgp_dados_form['id_articulo'];} 
          if (!isset($this->fecha_precio)){$this->fecha_precio = $this->nmgp_dados_form['fecha_precio'];} 
      }
...
//
      ...
      if (isset($this->codigo_barra)) { $this->nm_limpa_alfa($this->codigo_barra); }
      if (isset($this->rubro_id)) { $this->nm_limpa_alfa($this->rubro_id); }
      if (isset($this->descripcion)) { $this->nm_limpa_alfa($this->descripcion); }
      if (isset($this->unidad)) { $this->nm_limpa_alfa($this->unidad); }
      if (isset($this->costo)) { $this->nm_limpa_alfa($this->costo); }
      if (isset($this->coeficiente_ctdo)) { $this->nm_limpa_alfa($this->coeficiente_ctdo); }
      ...
      if (isset($this->stock_minimo)) { $this->nm_limpa_alfa($this->stock_minimo); }
      ...
      if (isset($this->lista_precio)) { $this->nm_limpa_alfa($this->lista_precio); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
   ...
   function loadFieldConfig()
   {
      ...
      //-- rubro_id
      $this->field_config['rubro_id']               = array();
      $this->field_config['rubro_id']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['rubro_id']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['rubro_id']['symbol_dec'] = '';
      $this->field_config['rubro_id']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['rubro_id']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- costo
      $this->field_config['costo']               = array();
      $this->field_config['costo']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['costo']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['costo']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['costo']['symbol_mon'] = '';
      $this->field_config['costo']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['costo']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- coeficiente_ctdo
      $this->field_config['coeficiente_ctdo']               = array();
      $this->field_config['coeficiente_ctdo']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['coeficiente_ctdo']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['coeficiente_ctdo']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['coeficiente_ctdo']['symbol_mon'] = '';
      $this->field_config['coeficiente_ctdo']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['coeficiente_ctdo']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- iva
      ...
      //-- lista_precio
      $this->field_config['lista_precio']               = array();
      $this->field_config['lista_precio']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['lista_precio']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['lista_precio']['symbol_dec'] = '';
      $this->field_config['lista_precio']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['lista_precio']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- activo
      $this->field_config['activo']               = array();
      $this->field_config['activo']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['activo']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['activo']['symbol_dec'] = '';
      $this->field_config['activo']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['activo']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- stock
      $this->field_config['stock']               = array();
      $this->field_config['stock']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['stock']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['stock']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['stock']['symbol_mon'] = '';
      $this->field_config['stock']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['stock']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- stock_minimo
      $this->field_config['stock_minimo']               = array();
      $this->field_config['stock_minimo']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['stock_minimo']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['stock_minimo']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['stock_minimo']['symbol_mon'] = '';
      $this->field_config['stock_minimo']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['stock_minimo']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- deposito
      $this->field_config['deposito']               = array();
      $this->field_config['deposito']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['deposito']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['deposito']['symbol_dec'] = '';
      $this->field_config['deposito']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['deposito']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- id_articulo
      $this->field_config['id_articulo']               = array();
      $this->field_config['id_articulo']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['id_articulo']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['id_articulo']['symbol_dec'] = '';
      $this->field_config['id_articulo']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['id_articulo']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- fecha_precio
      $this->field_config['fecha_precio']                 = array();
      $this->field_config['fecha_precio']['date_format']  = $_SESSION['scriptcase']['reg_conf']['date_format'];
      $this->field_config['fecha_precio']['date_sep']     = $_SESSION['scriptcase']['reg_conf']['date_sep'];
      $this->field_config['fecha_precio']['date_display'] = "ddmmaaaa";
      $this->new_date_format('DT', 'fecha_precio');
   }
...
//
      ...
      {
          if ('validate_codigo_barra' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'codigo_barra');
          }
          if ('validate_rubro_id' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'rubro_id');
          }
          ...
          if ('validate_costo' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'costo');
          }
          if ('validate_coeficiente_ctdo' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'coeficiente_ctdo');
          }
          ...
          if ('validate_lista_precio' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'lista_precio');
          }
          ...
          if ('validate_stock_minimo' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'stock_minimo');
          }
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if ('event_coeficiente_ctdo_onblur' == $this->NM_ajax_opcao)
          {
              $this->Coeficiente_Ctdo_onBlur();
          }
          if ('event_costo_onblur' == $this->NM_ajax_opcao)
          {
              $this->Costo_onBlur();
          }
          form_articulos_pack_ajax_response();
...
//--------------------------------------------------------------------------------------
   ...
   function Recupera_Nome_Campo($campo) 
   {
       ...
       {
           case 'codigo_barra':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Codigo_barra'] . "";
               break;
           case 'rubro_id':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_rubro_id'] . "";
               break;
           case 'descripcion':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Descripcion'] . "";
               break;
           case 'unidad':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_unidad'] . "";
               break;
           case 'costo':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Costo'] . "";
               break;
           case 'coeficiente_ctdo':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Coeficiente_Ctdo'] . "";
               break;
           case 'iva':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_IVA'] . "";
               break;
           case 'precio':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Precio'] . "";
               break;
           case 'lista_precio':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Lista_precio'] . "";
               break;
           case 'activo':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Activo'] . "";
               break;
           case 'stock':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Stock'] . "";
               break;
           case 'stock_minimo':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Stock_minimo'] . "";
               break;
           case 'deposito':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Deposito'] . "";
               break;
           case 'ubicacion':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Ubicacion'] . "";
               break;
           case 'id_articulo':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_id_articulo'] . "";
               break;
           case 'fecha_precio':
               return "" . $this->Ini->Nm_lang['lang_articulos_fld_Fecha_precio'] . "";
               break;
       }
...
//---------------------------------------------------------
     $this->sc_force_zero = array();
      if ('' == $filtro || 'codigo_barra' == $filtro)
        $this->ValidateField_codigo_barra($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'rubro_id' == $filtro)
        $this->ValidateField_rubro_id($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'costo' == $filtro)
        $this->ValidateField_costo($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'coeficiente_ctdo' == $filtro)
        $this->ValidateField_coeficiente_ctdo($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'lista_precio' == $filtro)
        $this->ValidateField_lista_precio($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ('' == $filtro || 'stock_minimo' == $filtro)
        $this->ValidateField_stock_minimo($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    function ValidateField_codigo_barra(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->codigo_barra) > 13) 
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Codigo_barra'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['codigo_barra']))
              {
                  $Campos_Erros['codigo_barra'] = array();
              }
              $Campos_Erros['codigo_barra'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['codigo_barra']) || !is_array($this->NM_ajax_info['errList']['codigo_barra']))
              {
                  $this->NM_ajax_info['errList']['codigo_barra'] = array();
              }
              $this->NM_ajax_info['errList']['codigo_barra'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 13 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_codigo_barra

    function ValidateField_rubro_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->rubro_id == "")  
      { 
          $this->rubro_id = 0;
          $this->sc_force_zero[] = 'rubro_id';
      } 
      nm_limpa_numero($this->rubro_id, $this->field_config['rubro_id']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->rubro_id != '')  
          { 
              $iTestSize = 6;
              if (strlen($this->rubro_id) > $iTestSize)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_rubro_id'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['rubro_id']))
                  {
                      $Campos_Erros['rubro_id'] = array();
                  }
                  $Campos_Erros['rubro_id'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['rubro_id']) || !is_array($this->NM_ajax_info['errList']['rubro_id']))
                  {
                      $this->NM_ajax_info['errList']['rubro_id'] = array();
                  }
                  $this->NM_ajax_info['errList']['rubro_id'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->rubro_id, 6, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_rubro_id'] . "; " ; 
                  if (!isset($Campos_Erros['rubro_id']))
                  {
                      $Campos_Erros['rubro_id'] = array();
                  }
                  $Campos_Erros['rubro_id'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['rubro_id']) || !is_array($this->NM_ajax_info['errList']['rubro_id']))
                  {
                      $this->NM_ajax_info['errList']['rubro_id'] = array();
                  }
                  $this->NM_ajax_info['errList']['rubro_id'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_rubro_id
    ...
    function ValidateField_descripcion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->descripcion) > 36) 
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Descripcion'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 36 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['descripcion']))
              {
                  $Campos_Erros['descripcion'] = array();
              }
              $Campos_Erros['descripcion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 36 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['descripcion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 36 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    ...
    function ValidateField_unidad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->unidad) > 4) 
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_unidad'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['unidad']))
              {
                  $Campos_Erros['unidad'] = array();
              }
              $Campos_Erros['unidad'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['unidad'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 4 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
    } // ValidateField_unidad

    function ValidateField_costo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->costo == "")  
      { 
          $this->costo = 0;
          $this->sc_force_zero[] = 'costo';
      } 
      if (!empty($this->field_config['costo']['symbol_dec']))
      {
          $this->sc_remove_currency($this->costo, $this->field_config['costo']['symbol_dec'], $this->field_config['costo']['symbol_grp'], $this->field_config['costo']['symbol_mon']); 
          nm_limpa_valor($this->costo, $this->field_config['costo']['symbol_dec'], $this->field_config['costo']['symbol_grp']) ; 
          if ('.' == substr($this->costo, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->costo, 1)))
              {
                  $this->costo = '';
              }
              else
              {
                  $this->costo = '0' . $this->costo;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 7;
              if (strlen($this->costo) > $iTestSize)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Costo'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['costo']))
                  {
                      $Campos_Erros['costo'] = array();
                  }
                  $Campos_Erros['costo'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['costo']) || !is_array($this->NM_ajax_info['errList']['costo']))
                  {
                      $this->NM_ajax_info['errList']['costo'] = array();
                  }
                  $this->NM_ajax_info['errList']['costo'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->costo, 4, 2, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Costo'] . "; " ; 
                  if (!isset($Campos_Erros['costo']))
                  {
                      $Campos_Erros['costo'] = array();
                  }
                  $Campos_Erros['costo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['costo']) || !is_array($this->NM_ajax_info['errList']['costo']))
                  {
                      $this->NM_ajax_info['errList']['costo'] = array();
                  }
                  $this->NM_ajax_info['errList']['costo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_costo

    function ValidateField_coeficiente_ctdo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->coeficiente_ctdo == "")  
      { 
          $this->coeficiente_ctdo = 0;
          $this->sc_force_zero[] = 'coeficiente_ctdo';
      } 
      if (!empty($this->field_config['coeficiente_ctdo']['symbol_dec']))
      {
          $this->sc_remove_currency($this->coeficiente_ctdo, $this->field_config['coeficiente_ctdo']['symbol_dec'], $this->field_config['coeficiente_ctdo']['symbol_grp'], $this->field_config['coeficiente_ctdo']['symbol_mon']); 
          nm_limpa_valor($this->coeficiente_ctdo, $this->field_config['coeficiente_ctdo']['symbol_dec'], $this->field_config['coeficiente_ctdo']['symbol_grp']) ; 
          if ('.' == substr($this->coeficiente_ctdo, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->coeficiente_ctdo, 1)))
              {
                  $this->coeficiente_ctdo = '';
              }
              else
              {
                  $this->coeficiente_ctdo = '0' . $this->coeficiente_ctdo;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 7;
              if (strlen($this->coeficiente_ctdo) > $iTestSize)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Coeficiente_Ctdo'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['coeficiente_ctdo']))
                  {
                      $Campos_Erros['coeficiente_ctdo'] = array();
                  }
                  $Campos_Erros['coeficiente_ctdo'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['coeficiente_ctdo']) || !is_array($this->NM_ajax_info['errList']['coeficiente_ctdo']))
                  {
                      $this->NM_ajax_info['errList']['coeficiente_ctdo'] = array();
                  }
                  $this->NM_ajax_info['errList']['coeficiente_ctdo'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->coeficiente_ctdo, 4, 2, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Coeficiente_Ctdo'] . "; " ; 
                  if (!isset($Campos_Erros['coeficiente_ctdo']))
                  {
                      $Campos_Erros['coeficiente_ctdo'] = array();
                  }
                  $Campos_Erros['coeficiente_ctdo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['coeficiente_ctdo']) || !is_array($this->NM_ajax_info['errList']['coeficiente_ctdo']))
                  {
                      $this->NM_ajax_info['errList']['coeficiente_ctdo'] = array();
                  }
                  $this->NM_ajax_info['errList']['coeficiente_ctdo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_coeficiente_ctdo
    ...
    function ValidateField_iva(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_IVA'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_IVA'] . "; " ; 
                  if (!isset($Campos_Erros['iva']))
                  {
                      $Campos_Erros['iva'] = array();
                  }
    ...
    function ValidateField_precio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Precio'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->precio, 4, 2, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Precio'] . "; " ; 
                  if (!isset($Campos_Erros['precio']))
                  {
                      $Campos_Erros['precio'] = array();
                  }
    ...
    function ValidateField_lista_precio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->lista_precio == "")  
      { 
          $this->lista_precio = 0;
          $this->sc_force_zero[] = 'lista_precio';
      } 
      nm_limpa_numero($this->lista_precio, $this->field_config['lista_precio']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->lista_precio != '')  
          { 
              $iTestSize = 4;
              if (strlen($this->lista_precio) > $iTestSize)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Lista_precio'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['lista_precio']))
                  {
                      $Campos_Erros['lista_precio'] = array();
                  }
                  $Campos_Erros['lista_precio'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['lista_precio']) || !is_array($this->NM_ajax_info['errList']['lista_precio']))
                  {
                      $this->NM_ajax_info['errList']['lista_precio'] = array();
                  }
                  $this->NM_ajax_info['errList']['lista_precio'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->lista_precio, 4, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Lista_precio'] . "; " ; 
                  if (!isset($Campos_Erros['lista_precio']))
                  {
                      $Campos_Erros['lista_precio'] = array();
                  }
                  $Campos_Erros['lista_precio'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['lista_precio']) || !is_array($this->NM_ajax_info['errList']['lista_precio']))
                  {
                      $this->NM_ajax_info['errList']['lista_precio'] = array();
                  }
                  $this->NM_ajax_info['errList']['lista_precio'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_lista_precio
    ...
    function ValidateField_activo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      nm_limpa_numero($this->activo, $this->field_config['activo']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->activo != '')  
          { 
              $iTestSize = 4;
              if (strlen($this->activo) > $iTestSize)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Activo'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['activo']))
                  {
                      $Campos_Erros['activo'] = array();
                  }
                  $Campos_Erros['activo'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['activo'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->activo, 4, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Activo'] . "; " ; 
                  if (!isset($Campos_Erros['activo']))
                  {
                      $Campos_Erros['activo'] = array();
                  }
    ...
    function ValidateField_stock(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      {
          $this->sc_remove_currency($this->stock, $this->field_config['stock']['symbol_dec'], $this->field_config['stock']['symbol_grp'], $this->field_config['stock']['symbol_mon']); 
      ...
      { 
          ...
          { 
              ...
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Stock'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->stock, 4, 2, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Stock'] . "; " ; 
                  if (!isset($Campos_Erros['stock']))
                  {
                      $Campos_Erros['stock'] = array();
                  }
    ...
    function ValidateField_stock_minimo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
      if ($this->stock_minimo == "")  
      { 
          $this->stock_minimo = 0;
          $this->sc_force_zero[] = 'stock_minimo';
      } 
      if (!empty($this->field_config['stock_minimo']['symbol_dec']))
      {
          $this->sc_remove_currency($this->stock_minimo, $this->field_config['stock_minimo']['symbol_dec'], $this->field_config['stock_minimo']['symbol_grp'], $this->field_config['stock_minimo']['symbol_mon']); 
          nm_limpa_valor($this->stock_minimo, $this->field_config['stock_minimo']['symbol_dec'], $this->field_config['stock_minimo']['symbol_grp']) ; 
          if ('.' == substr($this->stock_minimo, 0, 1))
          {
              if ('' == str_replace('0', '', substr($this->stock_minimo, 1)))
              {
                  $this->stock_minimo = '';
              }
              else
              {
                  $this->stock_minimo = '0' . $this->stock_minimo;
              }
          }
      }
      if ($this->nmgp_opcao != "excluir") 
      { 
          ...
          { 
              $iTestSize = 7;
              if (strlen($this->stock_minimo) > $iTestSize)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Stock_minimo'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['stock_minimo']))
                  {
                      $Campos_Erros['stock_minimo'] = array();
                  }
                  $Campos_Erros['stock_minimo'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['stock_minimo']) || !is_array($this->NM_ajax_info['errList']['stock_minimo']))
                  {
                      $this->NM_ajax_info['errList']['stock_minimo'] = array();
                  }
                  $this->NM_ajax_info['errList']['stock_minimo'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->stock_minimo, 4, 2, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Stock_minimo'] . "; " ; 
                  if (!isset($Campos_Erros['stock_minimo']))
                  {
                      $Campos_Erros['stock_minimo'] = array();
                  }
                  $Campos_Erros['stock_minimo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['stock_minimo']) || !is_array($this->NM_ajax_info['errList']['stock_minimo']))
                  {
                      $this->NM_ajax_info['errList']['stock_minimo'] = array();
                  }
                  $this->NM_ajax_info['errList']['stock_minimo'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    } // ValidateField_stock_minimo
    ...
    function ValidateField_deposito(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          $this->deposito = 0;
          $this->sc_force_zero[] = 'deposito';
      } 
      nm_limpa_numero($this->deposito, $this->field_config['deposito']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->deposito != '')  
          { 
              $iTestSize = 6;
              if (strlen($this->deposito) > $iTestSize)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Deposito'] . ": " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['deposito']))
                  {
                      $Campos_Erros['deposito'] = array();
                  }
                  $Campos_Erros['deposito'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['deposito'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->deposito, 6, 0, 0, 0, "N") == false)  
              { 
                  $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Deposito'] . "; " ; 
                  if (!isset($Campos_Erros['deposito']))
                  {
                      $Campos_Erros['deposito'] = array();
                  }
                  $Campos_Erros['deposito'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['deposito']) || !is_array($this->NM_ajax_info['errList']['deposito']))
                  {
                      $this->NM_ajax_info['errList']['deposito'] = array();
                  }
                  $this->NM_ajax_info['errList']['deposito'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
    ...
    function ValidateField_ubicacion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->ubicacion) > 24) 
          { 
              $Campos_Crit .= "" . $this->Ini->Nm_lang['lang_articulos_fld_Ubicacion'] . " " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 24 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['ubicacion']))
              {
                  $Campos_Erros['ubicacion'] = array();
              }
              $Campos_Erros['ubicacion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 24 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['ubicacion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 24 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
   ...
   function nm_guardar_campos()
   {
    global
           $sc_seq_vert;
    $this->nmgp_dados_form['codigo_barra'] = $this->codigo_barra;
    $this->nmgp_dados_form['rubro_id'] = $this->rubro_id;
    $this->nmgp_dados_form['descripcion'] = $this->descripcion;
    $this->nmgp_dados_form['unidad'] = $this->unidad;
    $this->nmgp_dados_form['costo'] = $this->costo;
    $this->nmgp_dados_form['coeficiente_ctdo'] = $this->coeficiente_ctdo;
    $this->nmgp_dados_form['iva'] = $this->iva;
    $this->nmgp_dados_form['precio'] = $this->precio;
    $this->nmgp_dados_form['lista_precio'] = $this->lista_precio;
    $this->nmgp_dados_form['activo'] = $this->activo;
    $this->nmgp_dados_form['stock'] = $this->stock;
    $this->nmgp_dados_form['stock_minimo'] = $this->stock_minimo;
    $this->nmgp_dados_form['deposito'] = $this->deposito;
    $this->nmgp_dados_form['ubicacion'] = $this->ubicacion;
    $this->nmgp_dados_form['id_articulo'] = $this->id_articulo;
    $this->nmgp_dados_form['fecha_precio'] = $this->fecha_precio;
   ...
   function nm_tira_formatacao()
   {
      ...
      nm_limpa_numero($this->deposito, $this->field_config['deposito']['symbol_grp']) ; 
      nm_limpa_numero($this->id_articulo, $this->field_config['id_articulo']['symbol_grp']) ; 
      nm_limpa_data($this->fecha_precio, $this->field_config['fecha_precio']['date_sep']) ; 
   }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "coeficiente_ctdo")
      {
          if (!empty($this->field_config['coeficiente_ctdo']['symbol_dec']))
          {
             $this->sc_remove_currency($this->coeficiente_ctdo, $this->field_config['coeficiente_ctdo']['symbol_dec'], $this->field_config['coeficiente_ctdo']['symbol_grp'], $this->field_config['coeficiente_ctdo']['symbol_mon']);
      ...
      if ($Nome_Campo == "lista_precio")
      {
          nm_limpa_numero($this->lista_precio, $this->field_config['lista_precio']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "activo")
      {
          nm_limpa_numero($this->activo, $this->field_config['activo']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "stock")
      ...
      if ($Nome_Campo == "deposito")
      {
          nm_limpa_numero($this->deposito, $this->field_config['deposito']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "id_articulo")
      {
          nm_limpa_numero($this->id_articulo, $this->field_config['id_articulo']['symbol_grp']) ; 
      }
   }
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if (!empty($this->rubro_id) || (!empty($format_fields) && isset($format_fields['rubro_id'])))
      {
          nmgp_Form_Num_Val($this->rubro_id, $this->field_config['rubro_id']['symbol_grp'], $this->field_config['rubro_id']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['rubro_id']['symbol_fmt']) ; 
      }
      if (!empty($this->costo) || (!empty($format_fields) && isset($format_fields['costo'])))
      {
          nmgp_Form_Num_Val($this->costo, $this->field_config['costo']['symbol_grp'], $this->field_config['costo']['symbol_dec'], "2", "S", "", "", "", "-", $this->field_config['costo']['symbol_fmt']) ; 
          $sMonSymb = $this->field_config['costo']['symbol_mon'];
          $this->sc_add_currency($this->costo, $sMonSymb, $this->field_config['costo']['format_pos']); 
      }
      if (!empty($this->coeficiente_ctdo) || (!empty($format_fields) && isset($format_fields['coeficiente_ctdo'])))
      {
          nmgp_Form_Num_Val($this->coeficiente_ctdo, $this->field_config['coeficiente_ctdo']['symbol_grp'], $this->field_config['coeficiente_ctdo']['symbol_dec'], "2", "S", "", "", "", "-", $this->field_config['coeficiente_ctdo']['symbol_fmt']) ; 
          $sMonSymb = $this->field_config['coeficiente_ctdo']['symbol_mon'];
          $this->sc_add_currency($this->coeficiente_ctdo, $sMonSymb, $this->field_config['coeficiente_ctdo']['format_pos']); 
      }
      ...
      if (!empty($this->lista_precio) || (!empty($format_fields) && isset($format_fields['lista_precio'])))
      {
          nmgp_Form_Num_Val($this->lista_precio, $this->field_config['lista_precio']['symbol_grp'], $this->field_config['lista_precio']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['lista_precio']['symbol_fmt']) ; 
      }
      if (!empty($this->activo) || (!empty($format_fields) && isset($format_fields['activo'])))
      {
          nmgp_Form_Num_Val($this->activo, $this->field_config['activo']['symbol_grp'], $this->field_config['activo']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['activo']['symbol_fmt']) ; 
      }
      if (!empty($this->stock) || (!empty($format_fields) && isset($format_fields['stock'])))
      {
          nmgp_Form_Num_Val($this->stock, $this->field_config['stock']['symbol_grp'], $this->field_config['stock']['symbol_dec'], "2", "S", "", "", "", "-", $this->field_config['stock']['symbol_fmt']) ; 
          $sMonSymb = $this->field_config['stock']['symbol_mon'];
          $this->sc_add_currency($this->stock, $sMonSymb, $this->field_config['stock']['format_pos']); 
      }
      if (!empty($this->stock_minimo) || (!empty($format_fields) && isset($format_fields['stock_minimo'])))
      {
          nmgp_Form_Num_Val($this->stock_minimo, $this->field_config['stock_minimo']['symbol_grp'], $this->field_config['stock_minimo']['symbol_dec'], "2", "S", "", "", "", "-", $this->field_config['stock_minimo']['symbol_fmt']) ; 
          $sMonSymb = $this->field_config['stock_minimo']['symbol_mon'];
          $this->sc_add_currency($this->stock_minimo, $sMonSymb, $this->field_config['stock_minimo']['format_pos']); 
      }
      if (!empty($this->deposito) || (!empty($format_fields) && isset($format_fields['deposito'])))
      {
          nmgp_Form_Num_Val($this->deposito, $this->field_config['deposito']['symbol_grp'], $this->field_config['deposito']['symbol_dec'], "0", "S", "", "", "", "-", $this->field_config['deposito']['symbol_fmt']) ; 
      }
   }
...
//-- 
   ...
   {
          $this->ajax_return_values_codigo_barra();
          $this->ajax_return_values_rubro_id();
          $this->ajax_return_values_descripcion();
          $this->ajax_return_values_unidad();
          $this->ajax_return_values_costo();
          $this->ajax_return_values_coeficiente_ctdo();
          $this->ajax_return_values_iva();
          $this->ajax_return_values_precio();
          $this->ajax_return_values_lista_precio();
          $this->ajax_return_values_activo();
          $this->ajax_return_values_stock();
          $this->ajax_return_values_stock_minimo();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_articulo']['keyVal'] = form_articulos_pack_protect_string($this->nmgp_dados_form['id_articulo']);
          }
   } // ajax_return_values

          //----- codigo_barra
   function ajax_return_values_codigo_barra($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("codigo_barra", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->codigo_barra);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['codigo_barra'] = array(
                       'row'    => '',
               'type'    => 'text',
          ...
          //----- rubro_id
   function ajax_return_values_rubro_id($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("rubro_id", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->rubro_id);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['rubro_id'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_unidad($bForce = false)
   {
          ...
          //----- costo
   function ajax_return_values_costo($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("costo", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->costo);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['costo'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
          ...
          //----- coeficiente_ctdo
   function ajax_return_values_coeficiente_ctdo($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("coeficiente_ctdo", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->coeficiente_ctdo);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['coeficiente_ctdo'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_precio($bForce = false)
   {
          ...
          //----- lista_precio
   function ajax_return_values_lista_precio($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("lista_precio", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->lista_precio);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['lista_precio'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
   ...
   function ajax_return_values_stock($bForce = false)
   {
          ...
          //----- stock_minimo
   function ajax_return_values_stock_minimo($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("stock_minimo", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->stock_minimo);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['stock_minimo'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
...
//
   ...
   { 
      $this->costo = str_replace($sc_parm1, $sc_parm2, $this->costo); 
      $this->coeficiente_ctdo = str_replace($sc_parm1, $sc_parm2, $this->coeficiente_ctdo); 
      ...
      $this->stock_minimo = str_replace($sc_parm1, $sc_parm2, $this->stock_minimo); 
   } 
   function nm_poe_aspas_decimal() 
   { 
      $this->costo = "'" . $this->costo . "'";
      $this->coeficiente_ctdo = "'" . $this->coeficiente_ctdo . "'";
      $this->iva = "'" . $this->iva . "'";
      $this->precio = "'" . $this->precio . "'";
      $this->stock = "'" . $this->stock . "'";
      $this->stock_minimo = "'" . $this->stock_minimo . "'";
   } 
...
//----------- 
   ...
   { 
      ...
      $NM_val_form['codigo_barra'] = $this->codigo_barra;
      $NM_val_form['rubro_id'] = $this->rubro_id;
      $NM_val_form['descripcion'] = $this->descripcion;
      $NM_val_form['unidad'] = $this->unidad;
      $NM_val_form['costo'] = $this->costo;
      $NM_val_form['coeficiente_ctdo'] = $this->coeficiente_ctdo;
      $NM_val_form['iva'] = $this->iva;
      $NM_val_form['precio'] = $this->precio;
      $NM_val_form['lista_precio'] = $this->lista_precio;
      $NM_val_form['activo'] = $this->activo;
      $NM_val_form['stock'] = $this->stock;
      $NM_val_form['stock_minimo'] = $this->stock_minimo;
      $NM_val_form['deposito'] = $this->deposito;
      $NM_val_form['ubicacion'] = $this->ubicacion;
      $NM_val_form['id_articulo'] = $this->id_articulo;
      $NM_val_form['fecha_precio'] = $this->fecha_precio;
      if ($this->id_articulo == "")  
      { 
          $this->id_articulo = 0;
      } 
      ...
      {
          $this->codigo_barra = substr($this->Db->qstr($this->codigo_barra), 1, -1); 
          ...
          if ($this->fecha_precio == "")  
          { 
              $this->fecha_precio = "null"; 
              $NM_val_null[] = "fecha_precio";
          } 
          if ($this->nmgp_opcao == "alterar") 
          {
          }
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select count(*) from " . $this->Ini->nm_tabela . " where id_articulo = $this->id_articulo ";
          $rs1 = $this->Db->Execute("select count(*) from " . $this->Ini->nm_tabela . " where id_articulo = $this->id_articulo "); 
          if ($rs1 === false)  
          { 
              $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dbas'], $this->Db->ErrorMsg()); 
              if ($this->NM_ajax_flag)
          ...
          { 
              $rs1->Close(); 
              $comando_oracle = "";  
              $comando = "UPDATE " . $this->Ini->nm_tabela . " SET Codigo_barra = '$this->codigo_barra', rubro_id = $this->rubro_id, Descripcion = '$this->descripcion', unidad = '$this->unidad', Costo = $this->costo, Coeficiente_Ctdo = $this->coeficiente_ctdo, IVA = $this->iva, Precio = $this->precio, Stock = $this->stock, Stock_minimo = $this->stock_minimo, Deposito = $this->deposito, Ubicacion = '$this->ubicacion', Activo = $this->activo, Lista_precio = $this->lista_precio";  
              if (isset($NM_val_form['fecha_precio']) && $NM_val_form['fecha_precio'] != $this->nmgp_dados_select['fecha_precio']) 
              { 
                  ...
                  $comando        .= " Fecha_precio = '$this->fecha_precio'"; 
                  $comando_oracle        .= " Fecha_precio = '$this->fecha_precio'"; 
                  $SC_ex_update = true; 
                  $SC_ex_upd_or = true; 
              } 
              ...
              $comando .= " WHERE id_articulo = $this->id_articulo ";  
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['codigo_barra'])) { $this->codigo_barra = $NM_val_form['codigo_barra']; }
              elseif (isset($this->codigo_barra)) { $this->nm_limpa_alfa($this->codigo_barra); }
              if     (isset($NM_val_form) && isset($NM_val_form['rubro_id'])) { $this->rubro_id = $NM_val_form['rubro_id']; }
              elseif (isset($this->rubro_id)) { $this->nm_limpa_alfa($this->rubro_id); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['costo'])) { $this->costo = $NM_val_form['costo']; }
              elseif (isset($this->costo)) { $this->nm_limpa_alfa($this->costo); }
              if     (isset($NM_val_form) && isset($NM_val_form['coeficiente_ctdo'])) { $this->coeficiente_ctdo = $NM_val_form['coeficiente_ctdo']; }
              elseif (isset($this->coeficiente_ctdo)) { $this->nm_limpa_alfa($this->coeficiente_ctdo); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['stock_minimo'])) { $this->stock_minimo = $NM_val_form['stock_minimo']; }
              elseif (isset($this->stock_minimo)) { $this->nm_limpa_alfa($this->stock_minimo); }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['lista_precio'])) { $this->lista_precio = $NM_val_form['lista_precio']; }
              elseif (isset($this->lista_precio)) { $this->nm_limpa_alfa($this->lista_precio); }

              $this->nm_formatar_campos();

              $aOldRefresh               = $this->nmgp_refresh_fields;
              $this->nmgp_refresh_fields = array('codigo_barra', 'rubro_id', 'descripcion', 'unidad', 'costo', 'coeficiente_ctdo', 'iva', 'precio', 'lista_precio', 'activo', 'stock', 'stock_minimo', 'deposito', 'ubicacion');
              $this->ajax_return_values();
      ...
      { 
          ...
          { 
              ...
              if ($this->lista_precio != "")
              { 
                   $compl_insert     .= ", Lista_precio";
                   $compl_insert_val .= ", $this->lista_precio";
              } 
              $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "Codigo_barra, rubro_id, Descripcion, unidad, Costo, Coeficiente_Ctdo, IVA, Precio, Stock, Stock_minimo, Deposito, Ubicacion, Fecha_precio $compl_insert) VALUES (" . $NM_seq_auto . "'$this->codigo_barra', $this->rubro_id, '$this->descripcion', '$this->unidad', $this->costo, $this->coeficiente_ctdo, $this->iva, $this->precio, $this->stock, $this->stock_minimo, $this->deposito, '$this->ubicacion', '$this->fecha_precio' $compl_insert_val)"; 
              $comando = str_replace("'null'", "null", $comando) ; 
              $comando = str_replace("#null#", "null", $comando) ; 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $comando; 
              $rs = $this->Db->Execute($comando); 
      ...
      if ($this->nmgp_opcao == "excluir") 
      { 
          $this->id_articulo = substr($this->Db->qstr($this->id_articulo), 1, -1); 
          ...
          { 
              $rs1->Close(); 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "DELETE FROM " . $this->Ini->nm_tabela . " where id_articulo = $this->id_articulo "; 
              $rs = $this->Db->Execute("DELETE FROM " . $this->Ini->nm_tabela . " where id_articulo = $this->id_articulo "); 
              if ($rs === false) 
              { 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_articulos']['parms'] = "id_articulo?#?$this->id_articulo?@?"; 
      }
      $this->NM_commit_db(); 
...
//------------ 
      ...
      if ($this->nmgp_opcao != "nada" && (trim($this->id_articulo) === "")) 
      { 
      ...
      { 
          ...
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id_articulo))
          {
              $Key_Where = "id_articulo < $this->id_articulo "; 
...
//---------- 
      ...
      { 
          ...
          { 
              $aWhere[] = "id_articulo = $this->id_articulo"; 
              if (!empty($sc_where_filter))  
              {
          ...
          { 
              ...
              $this->nmgp_dados_select['id_articulo'] = $this->id_articulo;
              $this->codigo_barra = $rs->fields[1] ; 
              $this->nmgp_dados_select['codigo_barra'] = $this->codigo_barra;
              $this->rubro_id = $rs->fields[2] ; 
              $this->nmgp_dados_select['rubro_id'] = $this->rubro_id;
              ...
              $this->costo = trim($rs->fields[5]) ; 
              $this->nmgp_dados_select['costo'] = $this->costo;
              $this->coeficiente_ctdo = trim($rs->fields[6]) ; 
              $this->nmgp_dados_select['coeficiente_ctdo'] = $this->coeficiente_ctdo;
              $this->iva = trim($rs->fields[7]) ; 
              $this->nmgp_dados_select['iva'] = $this->iva;
              $this->precio = trim($rs->fields[8]) ; 
              $this->nmgp_dados_select['precio'] = $this->precio;
              $this->stock = trim($rs->fields[9]) ; 
              $this->nmgp_dados_select['stock'] = $this->stock;
              $this->stock_minimo = trim($rs->fields[10]) ; 
              $this->nmgp_dados_select['stock_minimo'] = $this->stock_minimo;
              ...
              $this->nmgp_dados_select['fecha_precio'] = $this->fecha_precio;
              $this->activo = $rs->fields[14] ; 
              $this->nmgp_dados_select['activo'] = $this->activo;
              $this->lista_precio = $rs->fields[15] ; 
              $this->nmgp_dados_select['lista_precio'] = $this->lista_precio;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
...
//-- 
   ...
   {  
     ...
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(id_articulo) from " . $this->Ini->nm_tabela . " where id_articulo < $this->id_articulo" . $str_where_filter; 
     $rs = $this->Db->Execute("select max(id_articulo) from " . $this->Ini->nm_tabela . " where id_articulo < $this->id_articulo" . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
     ...
     { 
         $this->id_articulo = substr($this->Db->qstr($rs->fields[0]), 1, -1); 
         $rs->Close();  
         $this->nmgp_opcao = "igual";  
         return ;  
     } 
...
//-- 
   ...
   {  
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $str_where_filter = ('' != $str_where_param) ? ' and ' . $str_where_param : '';
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(id_articulo) from " . $this->Ini->nm_tabela . " where id_articulo > $this->id_articulo" . $str_where_filter; 
     $rs = $this->Db->Execute("select min(id_articulo) from " . $this->Ini->nm_tabela . " where id_articulo > $this->id_articulo" . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
...
//-- 
   ...
   {   
     ...
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(id_articulo) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
     $rs = $this->Db->Execute("select min(id_articulo) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
...
//-- 
   ...
   { 
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $str_where_filter = ('' != $str_where_param) ? ' where ' . $str_where_param : '';
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(id_articulo) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select max(id_articulo) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     if ($rs === false && !$rs->EOF && $GLOBALS["NM_ERRO_IBASE"] != 1) 
     { 
         $this->Erro->mensagem (__FILE__, __LINE__, "banco", $this->Ini->Nm_lang['lang_errm_dber'], $this->Db->ErrorMsg()); 
         exit ; 
...
{
$_SESSION['scriptcase']['form_articulos']['contr_erro'] = 'on';
       
if($this->costo ==0){
    $this->costo ==1;
}
$this->precio =$this->costo *$this->coeficiente_ctdo ;

$_SESSION['scriptcase']['form_articulos']['contr_erro'] = 'off';
}
function Coeficiente_Ctdo_onBlur($coeficiente_ctdo)
{
$_SESSION['scriptcase']['form_articulos']['contr_erro'] = 'on';
       
$original_costo = $this->costo;
$original_precio = $this->precio;
$original_coeficiente_ctdo = $this->coeficiente_ctdo;
$original_coeficiente_ctdo = $this->coeficiente_ctdo;
$this->Calcula_Precio();

$modificado_costo = $this->costo;
$modificado_precio = $this->precio;
$modificado_coeficiente_ctdo = $this->coeficiente_ctdo;
$modificado_coeficiente_ctdo = $this->coeficiente_ctdo;
$this->nm_formatar_campos('costo', 'precio', 'coeficiente_ctdo');
if ($original_costo != $modificado_costo || (isset($bFlagRead_costo) && $bFlagRead_costo))
{
    $this->ajax_return_values_costo(true);
}
if ($original_precio != $modificado_precio || (isset($bFlagRead_precio) && $bFlagRead_precio))
{
    $this->ajax_return_values_precio(true);
}
if ($original_coeficiente_ctdo != $modificado_coeficiente_ctdo || (isset($bFlagRead_coeficiente_ctdo) && $bFlagRead_coeficiente_ctdo))
{
    $this->ajax_return_values_coeficiente_ctdo(true);
}
if ($original_coeficiente_ctdo != $modificado_coeficiente_ctdo || (isset($bFlagRead_coeficiente_ctdo) && $bFlagRead_coeficiente_ctdo))
{
    $this->ajax_return_values_coeficiente_ctdo(true);
...
<?php
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($field, $arg_search, $data_search)
   {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "Codigo_barra", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "rubro_id", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "Costo", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "Coeficiente_Ctdo", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "Lista_precio", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
      ...
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "Stock", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
          $this->SC_monta_condicao($comando, "Stock_minimo", $arg_search, $data_search);
      }
      if ($field == "SC_all_Cmp") 
      {
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "id_articulo";$nm_numeric[] = "rubro_id";$nm_numeric[] = "costo";$nm_numeric[] = "coeficiente_ctdo";$nm_numeric[] = "iva";$nm_numeric[] = "precio";$nm_numeric[] = "stock";$nm_numeric[] = "stock_minimo";$nm_numeric[] = "deposito";$nm_numeric[] = "activo";$nm_numeric[] = "lista_precio";
