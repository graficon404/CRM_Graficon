...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_formas_pago"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_formas_pago"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_formas_pago'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_formas_pago']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_formas_pago']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_formas_pago']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_formas_pago']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_formas_pago']['sc_modal']);
