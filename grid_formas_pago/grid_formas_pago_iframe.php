...
$oExportPdf = new grid_formas_pago_export_pdf;
$oExportPdf->exportPdf();

class grid_formas_pago_export_pdf {
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - formas_pago :: PDF</title>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_formas_pago_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_formas_pago']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_formas_pago']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_formas_pago.pdf';
$NM_tit_doc = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_formas_pago']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_formas_pago']['pdf_name'] : "grid_formas_pago.pdf";
$NM_pdfurl  = $STR_tmp;
$NM_target  = "_self";
$NM_volta   = "volta_grid";
?>
