...
class grid_caja_pesq
{
   ...
   function processa_ajax()
   {
      ...
      if (isset($this->NM_ajax_info['param']['id_caja_cond']))
      {
          $id_caja_cond = $this->NM_ajax_info['param']['id_caja_cond'];
      }
      if (isset($this->NM_ajax_info['param']['id_caja']))
      {
          $id_caja = $this->NM_ajax_info['param']['id_caja'];
      }
      ...
      if (isset($this->NM_ajax_info['param']['detalle_cond']))
      {
          $detalle_cond = $this->NM_ajax_info['param']['detalle_cond'];
      }
      if (isset($this->NM_ajax_info['param']['detalle']))
      {
          $detalle = $this->NM_ajax_info['param']['detalle'];
      }
         ...
         switch (strtoupper($condicao))
         {
            ...
            case "QP":     // 
               ...
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
            ...
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
            ...
            case "BW":     // 
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_caja'] ?></TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_caja_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_caja_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_caja_do_ajax_delete_filter(pos);
 }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_caja'] ?></span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $vendedor_id = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['vendedor_id']; 
          $vendedor_id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['vendedor_id_cond']; 
          $id_caja = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['id_caja']; 
          $id_caja_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['id_caja_cond']; 
          ...
          if (strtoupper($id_caja_cond) != "II" && strtoupper($id_caja_cond) != "QP" && strtoupper($id_caja_cond) != "NP" && strtoupper($id_caja_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_caja, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_caja_cond) || empty($id_caja_cond))
      {
         $id_caja_cond = "eq";
      }
      ...
      if (!isset($importe_cond) || empty($importe_cond))
      {
         $importe_cond = "eq";
      }
      ...
      if (isset($id_caja) && !empty($id_caja))
      {
         $tmp_pos = strpos($id_caja, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_caja = substr($id_caja, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['vendedor_id'])) ? $this->New_label['vendedor_id'] : "" . $this->Ini->Nm_lang['lang_caja_fld_Vendedor_id'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="vendedor_id_cond">
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['vendedor_id'])) ? $this->New_label['vendedor_id'] : "" . $this->Ini->Nm_lang['lang_caja_fld_Vendedor_id'] . "";
 $nmgp_tab_label .= "vendedor_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_vendedor_id" name="vendedor_id" value="<?php echo NM_encode_input($vendedor_id) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_caja'])) ? $this->New_label['id_caja'] : "" . $this->Ini->Nm_lang['lang_caja_fld_id_caja'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="id_caja_cond">
       <OPTION value="eq" <?php if ("eq" == $id_caja_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $id_caja_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_caja_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $id_caja_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_caja'])) ? $this->New_label['id_caja'] : "" . $this->Ini->Nm_lang['lang_caja_fld_id_caja'] . "";
 $nmgp_tab_label .= "id_caja?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_id_caja" name="id_caja" value="<?php echo NM_encode_input($id_caja) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "" . $this->Ini->Nm_lang['lang_caja_fld_Fecha'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="fecha_cond">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "" . $this->Ini->Nm_lang['lang_caja_fld_Fecha'] . "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['detalle'])) ? $this->New_label['detalle'] : "" . $this->Ini->Nm_lang['lang_caja_fld_Detalle'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="detalle_cond">
       <OPTION value="eq" <?php if ("eq" == $detalle_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $detalle_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $detalle_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $detalle_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['detalle'])) ? $this->New_label['detalle'] : "" . $this->Ini->Nm_lang['lang_caja_fld_Detalle'] . "";
 $nmgp_tab_label .= "detalle?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_detalle" name="detalle" value="<?php echo NM_encode_input($detalle) ?>" size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_caja']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_caja']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
function nm_tabula(obj, tam, cond)
{
 ...
 function sc_grid_caja_valida_seg(obj)
 {
     if (obj.value < 0 || obj.value > 59)
     {
 ...
 function sc_grid_caja_valida_cic(obj)
 {
     var x        = 0;
     var y        = 0;
     var soma     = 0;
 ...
 function sc_grid_caja_valida_cnpj(obj)
 {
     var x         = 0;
     var y         = 5;
     var soma      = 0;
 ...
 function sc_grid_caja_valida_ciccnpj(obj)
 {
     var CnpjIn = obj.value;
     CnpjIn = CnpjIn.replace(/[.]/g, '');
     CnpjIn = CnpjIn.replace(/[-]/g, '');
     ...
     if (CnpjIn.length <= 11)
     {
         return sc_grid_caja_valida_cic(obj);
     }
     else
     {
         return sc_grid_caja_valida_cnpj(obj);
     }
 }
 function sc_grid_caja_valida_cep(obj)
 {
     var CepIn = obj.value;
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "CRM_Graficon/grid_caja";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_caja']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      ...
      { 
          ...
          if ($id_caja_cond != "in")
          {
              nm_limpa_numero($id_caja, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $id_caja);
              foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
              {
                  $Nm_sc_valor = trim($Nm_sc_valor);
                  nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
          ...
          $NM_temp  = (isset($id_caja_cond)) ? $id_caja_cond : ""; 
          $NM_str_filter .= "id_caja_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_caja)) ? $id_caja : ""; 
          $NM_str_filter .= "id_caja#NMF#" . $NM_temp . "@NMF@"; 
          ...
          $NM_temp  = (isset($detalle_cond)) ? $detalle_cond : ""; 
          $NM_str_filter .= "detalle_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($detalle)) ? $detalle : ""; 
          $NM_str_filter .= "detalle#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_caja']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['vendedor_id_cond'] = 'select';
      $tp_html['id_caja_cond'] = 'select';
      $tp_html['fecha_cond'] = 'select';
      $tp_html['detalle_cond'] = 'select';
      $tp_html['vendedor_id'] = 'text';
      $tp_html['id_caja'] = 'text';
      $tp_html['fecha_dia'] = 'text';
      $tp_html['fecha_mes'] = 'text';
      $tp_html['fecha_ano'] = 'text';
      $tp_html['detalle'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "vendedor_id_cond" || $Cada_cmp[0] == "id_caja_cond"))
                  {
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = grid_caja_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_caja_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $vendedor_id_cond, $vendedor_id,
             $id_caja_cond, $id_caja,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano,
             $detalle_cond, $detalle, $nmgp_tab_label;
      ...
      $id_caja_cond_salva = $id_caja_cond; 
      if (!isset($id_caja_input_2) || $id_caja_input_2 == "")
      {
          $id_caja_input_2 = $id_caja;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['vendedor_id'] = $vendedor_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['vendedor_id_cond'] = $vendedor_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['id_caja'] = $id_caja; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['id_caja_cond'] = $id_caja_cond_salva; 
      ...
      $this->cmp_formatado['id_caja'] = $Conteudo;
      $Conteudo  = "";
      $Formato   = "";
      if (!empty($fecha_dia))
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['fecha'] = $Conteudo; 
      $Conteudo  = "";
      $Formato   = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['fecha_input_2'] = $Conteudo; 
      $Conteudo = $detalle;
      ...
      //----- $id_caja
      if (isset($id_caja) || $id_caja_cond == "nu" || $id_caja_cond == "nn")
      {
         $this->monta_condicao("id_caja", $id_caja_cond, $id_caja, "", "id_caja");
      }
...
//
      ...
      if (!empty($nm_psq_dt1) || $condicao == "NU" || $condicao == "NN")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['fecha']   = trim($nm_dt_compl); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['campos_busca']['fecha_input_2'] = trim($nm_dt_compl_2); 
      }
      $nm_tp_dado = "";

      //----- $detalle
      if (isset($detalle) || $detalle_cond == "nu" || $detalle_cond == "nn")
      {
   ...
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['where_pesq_ant'] = $this->comando . $this->comando_fim;
