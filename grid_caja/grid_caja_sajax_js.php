...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_caja_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_vendedor_id_cond = scAjaxGetFieldSelect("vendedor_id_cond");
    var var_vendedor_id = scAjaxGetFieldText("vendedor_id");
    var var_id_caja_cond = scAjaxGetFieldSelect("id_caja_cond");
    var var_id_caja = scAjaxGetFieldText("id_caja");
    ...
    var var_detalle_cond = scAjaxGetFieldSelect("detalle_cond");
    ...
    x_grid_caja_ajax_save_filter( var_vendedor_id_cond, var_vendedor_id, var_id_caja_cond, var_id_caja, var_fecha_cond, var_fecha_dia, var_fecha_mes, var_fecha_ano, var_detalle_cond, var_detalle, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_caja_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_caja_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_caja_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_caja_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_caja_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_caja_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_caja_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_caja_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_caja_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_caja_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "vendedor_id";
  ajax_field_list[1] = "id_caja";
  ajax_field_list[2] = "fecha";
  ajax_field_list[3] = "detalle";

  var ajax_error_list = {
    "vendedor_id": {"label": "{lang_caja_fld_Vendedor_id}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_caja": {"label": "{lang_caja_fld_id_caja}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "fecha": {"label": "{lang_caja_fld_Fecha}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "detalle": {"label": "{lang_caja_fld_Detalle}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
