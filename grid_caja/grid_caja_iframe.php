...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $Nm_lang['lang_tbl_caja'] ?> :: PDF</title>
 ...
 function checkPDF() {
  $.get(nm_url_rand("grid_caja_gauge_ctrl.php"), {
...
<?php
$NM_pdfbase = (isset($_SESSION['sc_session'][$aParams['script_case_init']]['grid_caja']['pdf_name'])) ? $_SESSION['sc_session'][$aParams['script_case_init']]['grid_caja']['pdf_name'] : 'sc_pdf_' . date('YmdHis') . '_' . rand(0, 1000) . '_grid_caja.pdf';
