...
$_SESSION['scriptcase']['grid_caja']['contr_erro'] = 'off'; 
   ...
   function NM_export_detalle()
   {
         ...
         {
             $this->detalle = mb_convert_encoding($this->detalle, "UTF-8");
         }
         $this->xml_registro .= " detalle =\"" . $this->trata_dados($this->detalle) . "\"";
   }
   //----- vendedor_id
   ...
   function NM_export_importe()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->importe))
         {
             $this->importe = mb_convert_encoding($this->importe, "UTF-8");
         }
         $this->xml_registro .= " importe =\"" . $this->trata_dados($this->importe) . "\"";
   }
   //----- total
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Ini->Nm_lang['lang_tbl_caja'] ?> :: XML</TITLE>
