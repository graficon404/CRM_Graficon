<?php  
  ...
  session_start() ;
  class grid_caja_form_teste
  {
  function grid_caja_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_caja</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_caja"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_caja_form_teste();
  $frm_teste->grid_caja_teste();
?>
