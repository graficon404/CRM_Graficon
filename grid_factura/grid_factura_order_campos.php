<?php
   ...
   session_start();
    $Ord_Cmp = new grid_factura_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_factura_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $_POST, $_GET;
   ...
   $tab_def_campos['numero_fac'] = "Numero_fac";
   $tab_converte["Numero_fac"]   = "numero_fac";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_converte["fecha"]   = "fecha";
   $tab_ger_campos['cliente_id'] = "on";
   $tab_def_campos['cliente_id'] = "cliente_id";
   $tab_converte["cliente_id"]   = "cliente_id";
   $tab_ger_campos['vendedor_id'] = "on";
   $tab_def_campos['vendedor_id'] = "vendedor_id";
   $tab_converte["vendedor_id"]   = "vendedor_id";
   $tab_ger_campos['forma_pago_id'] = "on";
   $tab_def_campos['forma_pago_id'] = "forma_pago_id";
   $tab_converte["forma_pago_id"]   = "forma_pago_id";
   $tab_ger_campos['condicion_vta_id'] = "on";
   $tab_def_campos['condicion_vta_id'] = "condicion_vta_id";
   $tab_converte["condicion_vta_id"]   = "condicion_vta_id";
   $tab_ger_campos['remito_nro'] = "on";
   $tab_def_campos['remito_nro'] = "Remito_nro";
   $tab_converte["Remito_nro"]   = "remito_nro";
   $tab_ger_campos['pedido_nro'] = "on";
   $tab_def_campos['pedido_nro'] = "Pedido_nro";
   $tab_converte["Pedido_nro"]   = "pedido_nro";
   $tab_ger_campos['subtotal'] = "on";
   $tab_def_campos['subtotal'] = "Subtotal";
   $tab_converte["Subtotal"]   = "subtotal";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_factura']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_factura']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       $ordem = (substr($campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $campo = substr($campo_sort, 1);
       $_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select'][$campo] = $ordem;
   }
?>
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
...
?>
       <OPTION value="<?php echo NM_encode_input($tab_def_campos[$NM_cada_field]); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['grid_factura']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_factura']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
...
?>
             <OPTION value="<?php echo NM_encode_input($class . $NM_cada_field); ?>" selected><?php echo $class . $_SESSION['sc_session'][$sc_init]['grid_factura']['labels'][$tab_converte[$NM_cada_field]]; ?></OPTION>
<?php
       }
   }
?>
