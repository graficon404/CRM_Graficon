<?php  
  ...
  session_start() ;
  class grid_factura_form_teste
  {
  function grid_factura_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">grid_factura</FONT></B> 
<br> 
<br> 
...
<input type=submit value="grid_factura"> 
</form> 
...
<?php
  ...
  $frm_teste = new grid_factura_form_teste();
  $frm_teste->grid_factura_teste();
?>
