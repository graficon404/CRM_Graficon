  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_factura" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_factura_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_numero_fac_cond = scAjaxGetFieldSelect("numero_fac_cond");
    var var_numero_fac = scAjaxGetFieldText("numero_fac");
    ...
    var var_cliente_id_cond = scAjaxGetFieldSelect("cliente_id_cond");
    var var_cliente_id = scAjaxGetFieldText("cliente_id");
    var var_vendedor_id_cond = scAjaxGetFieldSelect("vendedor_id_cond");
    var var_vendedor_id = scAjaxGetFieldText("vendedor_id");
    ...
    x_grid_factura_ajax_save_filter( var_numero_fac_cond, var_numero_fac, var_fecha_cond, var_fecha_dia, var_fecha_mes, var_fecha_ano, var_cliente_id_cond, var_cliente_id, var_vendedor_id_cond, var_vendedor_id, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_factura_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_factura_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_factura_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_factura_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_factura_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_factura_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_factura_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_factura_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_factura_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_factura_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[3] = "vendedor_id";

  var ajax_error_list = {
    "numero_fac": {"label": "{lang_factura_fld_Numero_fac}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "fecha": {"label": "{lang_factura_fld_fecha}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "cliente_id": {"label": "{lang_factura_fld_cliente_id}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "vendedor_id": {"label": "{lang_factura_fld_vendedor_id}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
