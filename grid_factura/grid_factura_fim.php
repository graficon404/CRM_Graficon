...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_factura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_factura"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_factura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_factura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_factura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_factura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_factura']['sc_modal']);
