  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_clientes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_clientes_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_titular_cond = scAjaxGetFieldSelect("titular_cond");
    var var_titular = scAjaxGetFieldText("titular");
    var var_id_cliente_cond = scAjaxGetFieldSelect("id_cliente_cond");
    ...
    x_grid_clientes_ajax_save_filter( var_titular_cond, var_titular, var_id_cliente_cond, var_id_cliente, var_cuit_cond, var_cuit, var_razon_social_cond, var_razon_social, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_clientes_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_clientes_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_clientes_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_clientes_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_clientes_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_clientes_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_clientes_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_clientes_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_clientes_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_clientes_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "titular";
  ajax_field_list[1] = "id_cliente";
  ajax_field_list[2] = "cuit";
  ajax_field_list[3] = "razon_social";

  var ajax_error_list = {
    "titular": {"label": "{lang_clientes_fld_Titular}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_cliente": {"label": "{lang_clientes_fld_Id_Cliente}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "cuit": {"label": "{lang_clientes_fld_CUIT}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "razon_social": {"label": "{lang_clientes_fld_Razon_Social}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
