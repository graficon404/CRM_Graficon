...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $_POST, $_GET;
   ...
   $tab_ger_campos['titular'] = "on";
   $tab_def_campos['titular'] = "Titular";
   $tab_converte["Titular"]   = "titular";
   $tab_ger_campos['domicilio'] = "on";
   $tab_def_campos['domicilio'] = "Domicilio";
   $tab_converte["Domicilio"]   = "domicilio";
   $tab_ger_campos['codigo_postal'] = "on";
   $tab_def_campos['codigo_postal'] = "Codigo_Postal";
   $tab_converte["Codigo_Postal"]   = "codigo_postal";
   ...
   $tab_ger_campos['telefonos'] = "on";
   $tab_def_campos['telefonos'] = "Telefonos";
   $tab_converte["Telefonos"]   = "telefonos";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_clientes'] ?></TITLE>
...
?>
       <OPTION value="<?php echo NM_encode_input($tab_def_campos[$NM_cada_field]); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
?>
             <OPTION value="<?php echo NM_encode_input($class . $NM_cada_field); ?>" selected><?php echo $class . $_SESSION['sc_session'][$sc_init]['grid_clientes']['labels'][$tab_converte[$NM_cada_field]]; ?></OPTION>
<?php
       }
   }
?>
