  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_situacion_iva" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_situacion_iva_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_id_sitiva_cond = scAjaxGetFieldSelect("id_sitiva_cond");
    ...
    x_grid_situacion_iva_ajax_save_filter( var_id_sitiva_cond, var_id_sitiva, var_descripcion_cond, var_descripcion, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_situacion_iva_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_situacion_iva_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_situacion_iva_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_situacion_iva_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_situacion_iva_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_situacion_iva_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_situacion_iva_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_situacion_iva_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_situacion_iva_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_situacion_iva_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  var ajax_error_list = {
    "id_sitiva": {"label": "ID Sit IVA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "descripcion": {"label": "Descripcion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
