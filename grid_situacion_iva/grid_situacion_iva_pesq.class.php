...
class grid_situacion_iva_pesq
{
    ...
    * @access  public
    */
   function grid_situacion_iva_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      ...
      $this->init();
      if (isset($this->NM_ajax_info['param']['id_sitiva_cond']))
      {
          $id_sitiva_cond = $this->NM_ajax_info['param']['id_sitiva_cond'];
      }
      if (isset($this->NM_ajax_info['param']['id_sitiva']))
      {
          $id_sitiva = $this->NM_ajax_info['param']['id_sitiva'];
      }
      ...
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_situacion_iva_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_situacion_iva_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_situacion_iva_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - situacion_iva</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_situacion_iva_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_situacion_iva_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_situacion_iva_do_ajax_delete_filter(pos);
 }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - situacion_iva</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_sitiva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['id_sitiva']; 
          $id_sitiva_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['id_sitiva_cond']; 
          $descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['descripcion']; 
          $descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['descripcion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['NM_operador']; 
          if (strtoupper($id_sitiva_cond) != "II" && strtoupper($id_sitiva_cond) != "QP" && strtoupper($id_sitiva_cond) != "NP" && strtoupper($id_sitiva_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_sitiva, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_sitiva_cond) || empty($id_sitiva_cond))
      {
         $id_sitiva_cond = "eq";
      }
      ...
      if (!isset($id_sitiva) || $id_sitiva == "")
      {
          $id_sitiva = "";
      }
      if (isset($id_sitiva) && !empty($id_sitiva))
      {
         $tmp_pos = strpos($id_sitiva, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_sitiva = substr($id_sitiva, 0, $tmp_pos);
         }
      }
...
<?php
   if (is_file("grid_situacion_iva_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_sitiva'])) ? $this->New_label['id_sitiva'] : "ID Sit IVA"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="id_sitiva_cond">
       <OPTION value="eq" <?php if ("eq" == $id_sitiva_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $id_sitiva_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_sitiva_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $id_sitiva_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
 ...
 $nmgp_tab_label .= "id_sitiva?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_id_sitiva" name="id_sitiva" value="<?php echo NM_encode_input($id_sitiva) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="descripcion_cond">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_descripcion" name="descripcion" value="<?php echo NM_encode_input($descripcion) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_situacion_iva']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_situacion_iva']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "CRM_Graficon/grid_situacion_iva";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_situacion_iva']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      if (isset($nmgp_save_name) && !empty($nmgp_save_name))
      { 
          if ($id_sitiva_cond != "in")
          {
              nm_limpa_numero($id_sitiva, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $id_sitiva);
              ...
              $id_sitiva = implode(",", $Nm_sc_valores);
          }
          ...
          $NM_temp  = (isset($id_sitiva_cond)) ? $id_sitiva_cond : ""; 
          $NM_str_filter .= "id_sitiva_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_sitiva)) ? $id_sitiva : ""; 
          $NM_str_filter .= "id_sitiva#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_situacion_iva']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['id_sitiva_cond'] = 'select';
      $tp_html['descripcion_cond'] = 'select';
      $tp_html['id_sitiva'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "id_sitiva_cond"))
                  {
                      $$Cada_cmp[0] = trim($Cada_cmp[1]);
                  }
                  if ($SC_V6 && $Cada_cmp[0] == "id_sitiva")
                  {
                      if (strtoupper($id_sitiva_cond) != "II" && strtoupper($id_sitiva_cond) != "QP" && strtoupper($id_sitiva_cond) != "NP" && strtoupper($id_sitiva_cond) != "IN") 
                      { 
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = grid_situacion_iva_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_situacion_iva_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $id_sitiva_cond, $id_sitiva,
             $descripcion_cond, $descripcion, $nmgp_tab_label;

      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $id_sitiva_cond_salva = $id_sitiva_cond; 
      if (!isset($id_sitiva_input_2) || $id_sitiva_input_2 == "")
      {
          $id_sitiva_input_2 = $id_sitiva;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['id_sitiva'] = $id_sitiva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['id_sitiva_cond'] = $id_sitiva_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['descripcion'] = $descripcion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['descripcion_cond'] = $descripcion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $id_sitiva;
      if (strtoupper($id_sitiva_cond) != "II" && strtoupper($id_sitiva_cond) != "QP" && strtoupper($id_sitiva_cond) != "NP" && strtoupper($id_sitiva_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_sitiva'] = $Conteudo;
      $Conteudo = $descripcion;
      $this->cmp_formatado['descripcion'] = $Conteudo;

      //----- $id_sitiva
      if (isset($id_sitiva) || $id_sitiva_cond == "nu" || $id_sitiva_cond == "nn")
      {
         $this->monta_condicao("ID_SitIVA", $id_sitiva_cond, $id_sitiva, "", "id_sitiva");
      }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_situacion_iva']['where_pesq_ant'] = $this->comando . $this->comando_fim;
