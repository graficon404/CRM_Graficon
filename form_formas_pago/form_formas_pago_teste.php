<?php  
  session_start() ;
  class form_formas_pago_form_teste
  {
   function form_formas_pago_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "form_formas_pago/img";
...
?> 
<br> 
<B><FONT SIZE="4">form_formas_pago</FONT></B> 
<br> 
...
<input type="submit" value="form_formas_pago"> 
</form> 
...
<?php
  ...
  $frm_teste = new form_formas_pago_form_teste();
  $frm_teste->form_formas_pago_teste();
?>
