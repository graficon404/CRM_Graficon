  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_formas_pago" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_forma_pago
  function do_ajax_form_formas_pago_validate_id_forma_pago()
  {
    var nomeCampo_id_forma_pago = "id_forma_pago";
    var var_id_forma_pago = scAjaxGetFieldHidden(nomeCampo_id_forma_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formas_pago_validate_id_forma_pago(var_id_forma_pago, var_script_case_init, do_ajax_form_formas_pago_validate_id_forma_pago_cb);
  } // do_ajax_form_formas_pago_validate_id_forma_pago

  function do_ajax_form_formas_pago_validate_id_forma_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_forma_pago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formas_pago_validate_id_forma_pago_cb

  // ---------- Validate descripcion_fp
  function do_ajax_form_formas_pago_validate_descripcion_fp()
  {
    var nomeCampo_descripcion_fp = "descripcion_fp";
    var var_descripcion_fp = scAjaxGetFieldText(nomeCampo_descripcion_fp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formas_pago_validate_descripcion_fp(var_descripcion_fp, var_script_case_init, do_ajax_form_formas_pago_validate_descripcion_fp_cb);
  } // do_ajax_form_formas_pago_validate_descripcion_fp

  function do_ajax_form_formas_pago_validate_descripcion_fp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "descripcion_fp";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formas_pago_validate_descripcion_fp_cb

  // ---------- Validate incremento
  function do_ajax_form_formas_pago_validate_incremento()
  {
    var nomeCampo_incremento = "incremento";
    var var_incremento = scAjaxGetFieldText(nomeCampo_incremento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_formas_pago_validate_incremento(var_incremento, var_script_case_init, do_ajax_form_formas_pago_validate_incremento_cb);
  } // do_ajax_form_formas_pago_validate_incremento

  function do_ajax_form_formas_pago_validate_incremento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "incremento";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_formas_pago_validate_incremento_cb
  // ---------- Form
  function do_ajax_form_formas_pago_submit_form()
  {
    scAjaxHideMessage();
    var var_id_forma_pago = scAjaxGetFieldHidden("id_forma_pago");
    var var_descripcion_fp = scAjaxGetFieldText("descripcion_fp");
    var var_incremento = scAjaxGetFieldText("incremento");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_formas_pago_submit_form(var_id_forma_pago, var_descripcion_fp, var_incremento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_formas_pago_submit_form_cb);
  } // do_ajax_form_formas_pago_submit_form

  function do_ajax_form_formas_pago_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_forma_pago");
      scAjaxHideErrorDisplay("descripcion_fp");
      scAjaxHideErrorDisplay("incremento");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_formas_pago_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_formas_pago_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("descripcion_fp");
    scAjaxHideErrorDisplay("incremento");
    var var_id_forma_pago = document.F2.id_forma_pago.value;
    ...
    scAjaxProcOn();
    x_ajax_form_formas_pago_navigate_form(var_id_forma_pago, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_formas_pago_navigate_form_cb);
  } // do_ajax_form_formas_pago_navigate_form

  function do_ajax_form_formas_pago_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_forma_pago.value = scAjaxGetKeyValue("id_forma_pago");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
...
{
?>
    do_ajax_form_formas_pago_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_formas_pago_navigate_form_cb
  ...
  ajax_field_list[0] = "id_forma_pago";
  ajax_field_list[1] = "descripcion_fp";
  ajax_field_list[2] = "incremento";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_forma_pago": {"label": "Id Forma Pago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descripcion_fp": {"label": "Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "incremento": {"label": "Incremento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_forma_pago": new Array(),
    "descripcion_fp": new Array(),
    "incremento": new Array()
  };
  ajax_field_mult["id_forma_pago"][1] = "id_forma_pago";
  ajax_field_mult["descripcion_fp"][1] = "descripcion_fp";
  ajax_field_mult["incremento"][1] = "incremento";

  var ajax_field_id = {
    "id_forma_pago": new Array("hidden_field_label_id_forma_pago", "hidden_field_data_id_forma_pago"),
    "descripcion_fp": new Array("hidden_field_label_descripcion_fp", "hidden_field_data_descripcion_fp"),
    "incremento": new Array("hidden_field_label_incremento", "hidden_field_data_incremento")
  };
