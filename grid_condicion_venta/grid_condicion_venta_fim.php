...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_condicion_venta"]))
   {
      unset($_SESSION['session_sec_aplicacao']["CRM_Graficon_____grid_condicion_venta"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_condicion_venta'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_condicion_venta']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_condicion_venta']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_condicion_venta']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_condicion_venta']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_condicion_venta']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_condicion_venta</TITLE>
