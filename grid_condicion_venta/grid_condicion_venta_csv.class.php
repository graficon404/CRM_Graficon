...
class grid_condicion_venta_csv
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_condicion_venta_csv()
   {
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->arquivo    .= ".csv";
      $this->tit_doc    = "grid_condicion_venta.csv";
      $this->delim_dados = "\"";
      $this->delim_col   = ";";
      $this->delim_line  = "\r\n";
   }
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['csv_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['csv_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['csv_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['csv_name']);
      }
   ...
   function NM_export_id_condicion_vta()
   {
      ...
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->id_condicion_vta);
   ...
   {
      $col_sep = ($this->NM_prim_col > 0) ? $this->delim_col : "";
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->decripcion_vta);
      $this->csv_registro .= $col_sep . $this->delim_dados . $conteudo . $this->delim_dados;
      $this->NM_prim_col++;
   }
   //----- entrega
   function NM_export_entrega()
   {
      ...
      $col_sep = ($this->NM_prim_col > 0) ? $this->delim_col : "";
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->entrega);
      $this->csv_registro .= $col_sep . $this->delim_dados . $conteudo . $this->delim_dados;
      $this->NM_prim_col++;
   }
   //----- vecimiento
   function NM_export_vecimiento()
   {
      ...
      $col_sep = ($this->NM_prim_col > 0) ? $this->delim_col : "";
      $conteudo = str_replace($this->delim_dados, $this->delim_dados . $this->delim_dados, $this->vecimiento);
      $this->csv_registro .= $col_sep . $this->delim_dados . $conteudo . $this->delim_dados;
      $this->NM_prim_col++;
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - condicion_venta :: CSV</TITLE>
