...
class grid_condicion_venta_xml
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_condicion_venta_xml()
   {
   ...
   function inicializa_vars()
   {
      ...
      $this->arquivo     .= ".xml";
      $this->tit_doc      = "grid_condicion_venta.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['xml_name']))
      {
          $this->arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['xml_name'];
          $this->tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_condicion_venta";
   ...
   function NM_export_id_condicion_vta()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->id_condicion_vta))
         {
             $this->id_condicion_vta = mb_convert_encoding($this->id_condicion_vta, "UTF-8");
         }
         $this->xml_registro .= " id_condicion_vta =\"" . $this->trata_dados($this->id_condicion_vta) . "\"";
   }
   //----- decripcion_vta
   function NM_export_decripcion_vta()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->decripcion_vta))
         {
             $this->decripcion_vta = mb_convert_encoding($this->decripcion_vta, "UTF-8");
         }
         $this->xml_registro .= " decripcion_vta =\"" . $this->trata_dados($this->decripcion_vta) . "\"";
   }
   //----- entrega
   function NM_export_entrega()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->entrega))
         {
             $this->entrega = mb_convert_encoding($this->entrega, "UTF-8");
         }
         $this->xml_registro .= " entrega =\"" . $this->trata_dados($this->entrega) . "\"";
   }
   //----- vecimiento
   function NM_export_vecimiento()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->vecimiento))
         {
             $this->vecimiento = mb_convert_encoding($this->vecimiento, "UTF-8");
         }
         $this->xml_registro .= " vecimiento =\"" . $this->trata_dados($this->vecimiento) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_condicion_venta']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->arquivo;
      }
?>
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - condicion_venta :: XML</TITLE>
