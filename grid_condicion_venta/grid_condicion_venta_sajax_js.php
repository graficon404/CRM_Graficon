  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_condicion_venta" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_condicion_venta_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_vecimiento_cond = scAjaxGetFieldSelect("vecimiento_cond");
    var var_vecimiento = scAjaxGetFieldText("vecimiento");
    var var_id_condicion_vta_cond = scAjaxGetFieldSelect("id_condicion_vta_cond");
    var var_id_condicion_vta = scAjaxGetFieldText("id_condicion_vta");
    var var_decripcion_vta_cond = scAjaxGetFieldSelect("decripcion_vta_cond");
    var var_decripcion_vta = scAjaxGetFieldText("decripcion_vta");
    var var_entrega_cond = scAjaxGetFieldSelect("entrega_cond");
    ...
    x_grid_condicion_venta_ajax_save_filter( var_vecimiento_cond, var_vecimiento, var_id_condicion_vta_cond, var_id_condicion_vta, var_decripcion_vta_cond, var_decripcion_vta, var_entrega_cond, var_entrega, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_condicion_venta_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_condicion_venta_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_condicion_venta_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_condicion_venta_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_condicion_venta_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_condicion_venta_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_condicion_venta_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_condicion_venta_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_condicion_venta_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_condicion_venta_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "vecimiento";
  ajax_field_list[1] = "id_condicion_vta";
  ajax_field_list[2] = "decripcion_vta";
  ajax_field_list[3] = "entrega";

  var ajax_error_list = {
    "vecimiento": {"label": "Vecimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_condicion_vta": {"label": "Id Condicion Vta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "decripcion_vta": {"label": "Decripcion Vta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "entrega": {"label": "Entrega", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
