<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type=hidden name="id_proveedores" value="<?php echo NM_encode_input($this->nmgp_dados_form['id_proveedores']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_proveedores']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[2] = new NM_critica('F1', 'cuit', 'cuit', 'naomask', 'lista', 'cxab', 13, 'TUDO');
 NM_tab_crit[3] = new NM_critica('F1', 'ing_bruto', 'ing_bruto', 'naomask', 'lista', 'cxab', 13, 'TUDO');
 NM_tab_crit[4] = new NM_critica('F1', 'direccion', 'direccion', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit[5] = new NM_critica('F1', 'cod_postal', 'cod_postal', 'naomask', 'lista', 'cxab', 7, 'TUDO');
 NM_tab_crit[6] = new NM_critica('F1', 'localidad', 'localidad', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit[7] = new NM_critica('F1', 'provincia', 'provincia', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit[8] = new NM_critica('F1', 'telefono', 'telefono', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit[9] = new NM_critica('F1', 'e_mail', 'e_mail', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit[10] = new NM_critica('F1', 'contacto', 'contacto', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit[11] = new NM_critica('F1', 'observaciones', 'observaciones', 'naomask', 'lista', 'cxab', 32767, 'TUDO');
 ...
 NM_tab_crit_1[2] = new NM_critica('F1', 'cuit', 'cuit', 'naomask', 'lista', 'cxab', 13, 'TUDO');
 NM_tab_crit_1[3] = new NM_critica('F1', 'ing_bruto', 'ing_bruto', 'naomask', 'lista', 'cxab', 13, 'TUDO');
 NM_tab_crit_1[4] = new NM_critica('F1', 'direccion', 'direccion', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit_1[5] = new NM_critica('F1', 'cod_postal', 'cod_postal', 'naomask', 'lista', 'cxab', 7, 'TUDO');
 NM_tab_crit_1[6] = new NM_critica('F1', 'localidad', 'localidad', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit_1[7] = new NM_critica('F1', 'provincia', 'provincia', 'naomask', 'lista', 'cxab', 20, 'TUDO');
 NM_tab_crit_1[8] = new NM_critica('F1', 'telefono', 'telefono', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit_1[9] = new NM_critica('F1', 'e_mail', 'e_mail', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit_1[10] = new NM_critica('F1', 'contacto', 'contacto', 'naomask', 'lista', 'cxab', 24, 'TUDO');
 NM_tab_crit_1[11] = new NM_critica('F1', 'observaciones', 'observaciones', 'naomask', 'lista', 'cxab', 32767, 'TUDO');
