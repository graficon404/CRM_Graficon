...
class grid_vendedor_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function processa_ajax()
   {
      ...
      $observaciones_cond, $observaciones,
             $id_vendedor_cond, $id_vendedor,
             $vendedor_cond, $vendedor,
             $comision_cond, $comision,
      $NM_filters, $NM_filters_del, $nmgp_save_name, $NM_operador, $nmgp_save_option, $bprocessa, $Ajax_label, $Ajax_val, $Campo_bi, $Opc_bi;
      $this->init();
      if (isset($this->NM_ajax_info['param']['observaciones_cond']))
      {
          $observaciones_cond = $this->NM_ajax_info['param']['observaciones_cond'];
      }
      if (isset($this->NM_ajax_info['param']['observaciones']))
      {
          $observaciones = $this->NM_ajax_info['param']['observaciones'];
      }
      if (isset($this->NM_ajax_info['param']['id_vendedor_cond']))
      {
          $id_vendedor_cond = $this->NM_ajax_info['param']['id_vendedor_cond'];
      }
      if (isset($this->NM_ajax_info['param']['id_vendedor']))
      {
          $id_vendedor = $this->NM_ajax_info['param']['id_vendedor'];
      }
      if (isset($this->NM_ajax_info['param']['vendedor_cond']))
      {
          $vendedor_cond = $this->NM_ajax_info['param']['vendedor_cond'];
      }
      if (isset($this->NM_ajax_info['param']['vendedor']))
      {
          $vendedor = $this->NM_ajax_info['param']['vendedor'];
      }
      if (isset($this->NM_ajax_info['param']['comision_cond']))
      {
          $comision_cond = $this->NM_ajax_info['param']['comision_cond'];
      }
      if (isset($this->NM_ajax_info['param']['comision']))
      {
          $comision = $this->NM_ajax_info['param']['comision'];
      }
      ...
      if (isset($bprocessa) && $bprocessa == "save_form")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_vendedor_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_vendedor_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_vendedor_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch (strtoupper($condicao))
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "QP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " like '%" . $campo . "%'";
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " like '%" . $campo . "%'";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "NP":     // 
               if (substr($tp_campo, 0, 4) == "DATE")
               {
                   ...
                   if (!empty($NM_cmd))
                   {
                       ...
                       $this->comando_sum    .= $NM_cmd_sum;
                       $this->comando_filtro .= $NM_cmd;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_not_like'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $nmgp_lang['pesq_cond_maior'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               if ($tp_campo == "DTDF" || $tp_campo == "DATEDF" || $tp_campo == "DATETIMEDF")
               {
               ...
               else
               {
                   ...
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_andd'] . " " . $this->cmp_formatado[$nome_campo . "_Input_2"] . "##*@@";
                   }
               }
            break;
            case "IN":     // 
            ...
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] ." " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - vendedor</TITLE>
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  grid_vendedor_do_ajax_save_filter(pos);
 }
 function nm_submit_filter(obj_sel, pos)
 {
  ...
  grid_vendedor_do_ajax_change_filter(pos);
 }
 function nm_submit_filter_del(pos)
 {
  ...
  grid_vendedor_do_ajax_delete_filter(pos);
 }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - vendedor</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $observaciones = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['observaciones']; 
          $observaciones_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['observaciones_cond']; 
          $id_vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['id_vendedor']; 
          $id_vendedor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['id_vendedor_cond']; 
          $vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['vendedor']; 
          $vendedor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['vendedor_cond']; 
          $comision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['comision']; 
          $comision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['comision_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['NM_operador']; 
          if (strtoupper($id_vendedor_cond) != "II" && strtoupper($id_vendedor_cond) != "QP" && strtoupper($id_vendedor_cond) != "NP" && strtoupper($id_vendedor_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_vendedor, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($comision_cond) != "II" && strtoupper($comision_cond) != "QP" && strtoupper($comision_cond) != "NP" && strtoupper($comision_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($comision, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_vendedor_cond) || empty($id_vendedor_cond))
      {
         $id_vendedor_cond = "eq";
      }
      ...
      if (!isset($comision_cond) || empty($comision_cond))
      {
         $comision_cond = "eq";
      }
      ...
      if (!isset($id_vendedor) || $id_vendedor == "")
      {
          $id_vendedor = "";
      }
      if (isset($id_vendedor) && !empty($id_vendedor))
      {
         $tmp_pos = strpos($id_vendedor, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_vendedor = substr($id_vendedor, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($comision) || $comision == "")
      {
          $comision = "";
      }
      if (isset($comision) && !empty($comision))
      {
         $tmp_pos = strpos($comision, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $comision = substr($comision, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
   if (is_file("grid_vendedor_help.txt"))
   {
...
?>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['observaciones'])) ? $this->New_label['observaciones'] : "Observaciones"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="observaciones_cond">
       <OPTION value="eq" <?php if ("eq" == $observaciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $observaciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $observaciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $observaciones_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_observaciones" name="observaciones" value="<?php echo NM_encode_input($observaciones) ?>"   size="50" maxlength="32767" class="scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['id_vendedor'])) ? $this->New_label['id_vendedor'] : "Id Vendedor"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="id_vendedor_cond">
       <OPTION value="eq" <?php if ("eq" == $id_vendedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $id_vendedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $id_vendedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $id_vendedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $nmgp_tab_label .= "id_vendedor?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_id_vendedor" name="id_vendedor" value="<?php echo NM_encode_input($id_vendedor) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['vendedor'])) ? $this->New_label['vendedor'] : "Vendedor"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" name="vendedor_cond">
       <OPTION value="eq" <?php if ("eq" == $vendedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $vendedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $vendedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $vendedor_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
 ...
 $date_sep_bw = "";
?>
<INPUT  type="text" id="SC_vendedor" name="vendedor" value="<?php echo NM_encode_input($vendedor) ?>" size=24 alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['comision'])) ? $this->New_label['comision'] : "Comision"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" name="comision_cond">
       <OPTION value="eq" <?php if ("eq" == $comision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $comision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $comision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $comision_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_vendedor']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_vendedor']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_vendedor.value = "";
   document.F1.vendedor.value = "";
   document.F1.comision.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "CRM_Graficon/grid_vendedor";
   ...
   function inicializa_vars()
   {
      ...
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_vendedor']['path_libs_php'] . "/nm_gp_limpa.php");
      }
      if (isset($nmgp_save_name) && !empty($nmgp_save_name))
      { 
          if ($id_vendedor_cond != "in")
          {
              nm_limpa_numero($id_vendedor, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $id_vendedor);
              ...
              $id_vendedor = implode(",", $Nm_sc_valores);
          }
          if ($comision_cond != "in")
          {
              nm_limpa_numero($comision, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
          else
          {
              $Nm_sc_valores = explode(",", $comision);
              foreach ($Nm_sc_valores as $II => $Nm_sc_valor)
              {
                  $Nm_sc_valor = trim($Nm_sc_valor);
                  nm_limpa_numero($Nm_sc_valor, $_SESSION['scriptcase']['reg_conf']['grup_num']); 
              ...
              $comision = implode(",", $Nm_sc_valores);
          }
          ...
          $NM_temp  = (isset($observaciones_cond)) ? $observaciones_cond : ""; 
          $NM_str_filter .= "observaciones_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($observaciones)) ? $observaciones : ""; 
          $NM_str_filter .= "observaciones#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_vendedor_cond)) ? $id_vendedor_cond : ""; 
          $NM_str_filter .= "id_vendedor_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($id_vendedor)) ? $id_vendedor : ""; 
          $NM_str_filter .= "id_vendedor#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($vendedor_cond)) ? $vendedor_cond : ""; 
          $NM_str_filter .= "vendedor_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($vendedor)) ? $vendedor : ""; 
          $NM_str_filter .= "vendedor#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($comision_cond)) ? $comision_cond : ""; 
          $NM_str_filter .= "comision_cond#NMF#" . $NM_temp . "@NMF@"; 
          $NM_temp  = (isset($comision)) ? $comision : ""; 
          $NM_str_filter .= "comision#NMF#" . $NM_temp . "@NMF@"; 
   ...
   function recupera_filtro()
   {
      ...
      {
          include_once($_SESSION['sc_session'][$script_case_init]['grid_vendedor']['path_libs_php'] . "/nm_edit.php");
      }
      $Look_man = array();
      $tp_html['observaciones_cond'] = 'select';
      $tp_html['id_vendedor_cond'] = 'select';
      $tp_html['vendedor_cond'] = 'select';
      $tp_html['comision_cond'] = 'select';
      $tp_html['observaciones'] = 'text';
      $tp_html['id_vendedor'] = 'text';
      $tp_html['vendedor'] = 'text';
      $tp_html['comision'] = 'text';
      ...
      if (is_file($NM_patch))
      {
          ...
          foreach ($NMcmp_filter as $Cada_cmp)
          {
              ...
              {
                  if ($SC_V6 && ($Cada_cmp[0] == "id_vendedor_cond" || $Cada_cmp[0] == "comision_cond"))
                  {
                      $$Cada_cmp[0] = trim($Cada_cmp[1]);
                  }
                  if ($SC_V6 && $Cada_cmp[0] == "id_vendedor")
                  {
                      if (strtoupper($id_vendedor_cond) != "II" && strtoupper($id_vendedor_cond) != "QP" && strtoupper($id_vendedor_cond) != "NP" && strtoupper($id_vendedor_cond) != "IN") 
                      { 
                  ...
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                         ...
                         $Cada_val_sv1[] = grid_vendedor_pack_protect_string(trim($v_fim[0]));
                      }
                      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
                      {
                  ...
                  else
                  {
                      ...
                      $$Cada_cmp[0] = $Cada_val_sv;
                      $this->ajax_return_fields[$Cada_cmp[0]]['vallist'] = array(grid_vendedor_pack_protect_string(trim($Cada_cmp[1])));
                  }
              }
          }
   ...
   {
      global $observaciones_cond, $observaciones,
             $id_vendedor_cond, $id_vendedor,
             $vendedor_cond, $vendedor,
             $comision_cond, $comision, $nmgp_tab_label;
      ...
      $id_vendedor_cond_salva = $id_vendedor_cond; 
      if (!isset($id_vendedor_input_2) || $id_vendedor_input_2 == "")
      {
          $id_vendedor_input_2 = $id_vendedor;
      }
      ...
      $comision_cond_salva = $comision_cond; 
      if (!isset($comision_input_2) || $comision_input_2 == "")
      {
          $comision_input_2 = $comision;
      }
      if ($id_vendedor_cond != "in")
      {
          nm_limpa_numero($id_vendedor, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['observaciones'] = $observaciones; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['observaciones_cond'] = $observaciones_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['id_vendedor'] = $id_vendedor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['id_vendedor_cond'] = $id_vendedor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['vendedor'] = $vendedor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['vendedor_cond'] = $vendedor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['comision'] = $comision; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['comision_cond'] = $comision_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']['NM_operador'] = $this->NM_operador; 
      $Conteudo = $observaciones;
      $this->cmp_formatado['observaciones'] = $Conteudo;
      $Conteudo = $id_vendedor;
      if (strtoupper($id_vendedor_cond) != "II" && strtoupper($id_vendedor_cond) != "QP" && strtoupper($id_vendedor_cond) != "NP" && strtoupper($id_vendedor_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_vendedor'] = $Conteudo;
      $Conteudo = $vendedor;
      ...
      $this->cmp_formatado['comision'] = $Conteudo;

      //----- $observaciones
      if (isset($observaciones) || $observaciones_cond == "nu" || $observaciones_cond == "nn")
      {
         $this->monta_condicao("Observaciones", $observaciones_cond, $observaciones, "", "observaciones");
      }

      //----- $id_vendedor
      if (isset($id_vendedor) || $id_vendedor_cond == "nu" || $id_vendedor_cond == "nn")
      {
         $this->monta_condicao("id_vendedor", $id_vendedor_cond, $id_vendedor, "", "id_vendedor");
      }

      //----- $vendedor
      if (isset($vendedor) || $vendedor_cond == "nu" || $vendedor_cond == "nn")
      {
         $this->monta_condicao("Vendedor", $vendedor_cond, $vendedor, "", "vendedor");
      }

      //----- $comision
      if (isset($comision) || $comision_cond == "nu" || $comision_cond == "nn")
      {
         $this->monta_condicao("Comision", $comision_cond, $comision, "", "comision");
      }
   }
   ...
   {
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_vendedor']['where_pesq_ant'] = $this->comando . $this->comando_fim;
