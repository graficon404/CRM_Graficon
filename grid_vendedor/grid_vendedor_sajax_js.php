  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_vendedor" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_vendedor_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_observaciones_cond = scAjaxGetFieldSelect("observaciones_cond");
    var var_observaciones = scAjaxGetFieldText("observaciones");
    var var_id_vendedor_cond = scAjaxGetFieldSelect("id_vendedor_cond");
    var var_id_vendedor = scAjaxGetFieldText("id_vendedor");
    var var_vendedor_cond = scAjaxGetFieldSelect("vendedor_cond");
    var var_vendedor = scAjaxGetFieldText("vendedor");
    var var_comision_cond = scAjaxGetFieldSelect("comision_cond");
    ...
    x_grid_vendedor_ajax_save_filter( var_observaciones_cond, var_observaciones, var_id_vendedor_cond, var_id_vendedor, var_vendedor_cond, var_vendedor, var_comision_cond, var_comision, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_vendedor_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_vendedor_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_vendedor_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_vendedor_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_vendedor_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_vendedor_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_vendedor_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_vendedor_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_vendedor_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_vendedor_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[1] = "id_vendedor";
  ajax_field_list[2] = "vendedor";
  ajax_field_list[3] = "comision";

  var ajax_error_list = {
    "observaciones": {"label": "Observaciones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_vendedor": {"label": "Id Vendedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "vendedor": {"label": "Vendedor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "comision": {"label": "Comision", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
