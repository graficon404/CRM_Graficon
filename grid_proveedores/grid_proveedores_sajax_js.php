  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_grid_proveedores" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- save_filter
  function grid_proveedores_do_ajax_save_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    var var_ing_bruto_cond = scAjaxGetFieldSelect("ing_bruto_cond");
    var var_ing_bruto = scAjaxGetFieldText("ing_bruto");
    var var_id_proveedores_cond = scAjaxGetFieldSelect("id_proveedores_cond");
    var var_id_proveedores = scAjaxGetFieldText("id_proveedores");
    var var_razon_social_cond = scAjaxGetFieldSelect("razon_social_cond");
    var var_razon_social = scAjaxGetFieldText("razon_social");
    var var_cuit_cond = scAjaxGetFieldSelect("cuit_cond");
    ...
    x_grid_proveedores_ajax_save_filter( var_ing_bruto_cond, var_ing_bruto, var_id_proveedores_cond, var_id_proveedores, var_razon_social_cond, var_razon_social, var_cuit_cond, var_cuit, var_nmgp_save_name, var_NM_operador, var_script_case_init, var_bprocessa, grid_proveedores_do_ajax_save_filter_cb);
  } // do_ajax_save_filter

  function grid_proveedores_do_ajax_save_filter_cb(sResp)
  {
  ...
  // ---------- change_filter
  function grid_proveedores_do_ajax_change_filter(pos)
  {
    scAjaxProcOn();
    var var_NM_filters = scAjaxGetFieldSelect("NM_filters_" + pos);
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_proveedores_ajax_change_filter( var_NM_filters, var_script_case_init, var_bprocessa, grid_proveedores_do_ajax_change_filter_cb);
  } // do_ajax_change_filter

  function grid_proveedores_do_ajax_change_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    scAjaxProcOff();
  ...
  // ---------- delete_filter
  function grid_proveedores_do_ajax_delete_filter(pos)
  {
    NM_back_pos = pos;
    scAjaxProcOn();
    ...
    var var_script_case_init = scAjaxGetFieldText("script_case_init");
    var var_bprocessa = scAjaxGetFieldText("bprocessa");
    x_grid_proveedores_ajax_delete_filter( var_NM_filters_del, var_script_case_init, var_bprocessa, grid_proveedores_do_ajax_delete_filter_cb);
  } // do_ajax_delete_filter

  function grid_proveedores_do_ajax_delete_filter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxSetFields();
    if (NM_back_pos == 'top')
  ...
  ajax_field_list[0] = "ing_bruto";
  ajax_field_list[1] = "id_proveedores";
  ajax_field_list[2] = "razon_social";
  ajax_field_list[3] = "cuit";

  var ajax_error_list = {
    "ing_bruto": {"label": "{lang_proveedores_fld_Ing_Bruto}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "id_proveedores": {"label": "{lang_proveedores_fld_id_proveedores}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "razon_social": {"label": "{lang_proveedores_fld_Razon_social}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()},
    "cuit": {"label": "{lang_proveedores_fld_CUIT}", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array()}
  };
 </SCRIPT>
