...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $_POST, $_GET;
   ...
   $tab_converte["Razon_social"]   = "razon_social";
   $tab_ger_campos['cuit'] = "on";
   $tab_def_campos['cuit'] = "CUIT";
   $tab_converte["CUIT"]   = "cuit";
   $tab_ger_campos['ing_bruto'] = "on";
   $tab_def_campos['ing_bruto'] = "Ing_Bruto";
   $tab_converte["Ing_Bruto"]   = "ing_bruto";
   ...
   $tab_converte["Telefono"]   = "telefono";
   $tab_ger_campos['e_mail'] = "on";
   $tab_def_campos['e_mail'] = "E_mail";
   $tab_converte["E_mail"]   = "e_mail";
   $tab_ger_campos['contacto'] = "on";
   $tab_def_campos['contacto'] = "Contacto";
   $tab_converte["Contacto"]   = "contacto";
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - <?php echo $this->Nm_lang['lang_tbl_proveedores'] ?></TITLE>
...
?>
       <OPTION value="<?php echo NM_encode_input($tab_def_campos[$NM_cada_field]); ?>" <?php echo $tmp_sel; ?>><?php echo $_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
...
?>
             <OPTION value="<?php echo NM_encode_input($class . $NM_cada_field); ?>" selected><?php echo $class . $_SESSION['sc_session'][$sc_init]['grid_proveedores']['labels'][$tab_converte[$NM_cada_field]]; ?></OPTION>
<?php
       }
   }
?>
