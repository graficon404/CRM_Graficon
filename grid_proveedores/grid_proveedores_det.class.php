...
class grid_proveedores_det
{
 ...
 function monta_det()
 {
   ...
   $parms_det = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_proveedores']['chave_det']) ; 
   ...
   $nmgp_select .= " where  id_proveedores = $parms_det[0]" ;  
...
//--- 
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"scGridHeaderFont\"><span>" . $this->Ini->Nm_lang['lang_othr_grid_titl'] . " - " . $this->Ini->Nm_lang['lang_tbl_proveedores'] . "</span></td>\r\n");
   ...
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          $SC_Label = (isset($this->New_label['id_proveedores'])) ? $this->New_label['id_proveedores'] : ""; 
          $conteudo = trim($this->id_proveedores); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
   ...
   $nm_saida->saida("  <TR class=\"scGridLabel\">\r\n");
          ...
          $conteudo = trim($this->razon_social); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ; 
          } 
