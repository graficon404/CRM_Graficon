...
function Sel_cmp_init()
{
   ...
   {
       $_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['field_order'] = $_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['field_order_orig'];
       unset($_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['usr_cmp_sel']);
       $_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['prim_cmp_sel'] = true;
   }
   if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['prim_cmp_sel']))
   {
       $_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['prim_cmp_sel'] = true;
   }
...
function Sel_processa_out($opt_save=false)
{
   ...
   if ($arr_temp !== $_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['usr_cmp_sel'])
   {
       $_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['prim_cmp_sel'] = false;
   }
...
<?php
   ...
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           ...
           $prep_combo[strtolower($_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['labels'][$NM_cada_field])] = NM_encode_input($NM_cada_field) . '" ' . $tmp_sel . '>' . $_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['labels'][$NM_cada_field];
       }
   }
...
<?php
   foreach ($_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['field_order'] as $NM_cada_field)
   {
       ...
       {
?>
       <OPTION value="<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['grid_proveedores']['labels'][$NM_cada_field]; ?></OPTION>
<?php
       }
   }
?>
